...
//            ActualizaContenido((String)System.Web.HttpContext.Current.Session["ActualizaModulo"]);
        ...
        {
            //string sql = " SELECT MenuName, MenuOrder, MenuRaiz, Parent ParentId, tipo, action, menuaccess, menuimg, '0', menumsnro, menuraiz menunro ";                        
           ...
           // sql += " WHERE MR.menudir = '" + modulo + "'";
            sql += " WHERE MR.menudesc = '" + modulo + "'"; 
            ...
            { 
              //  if (Utils.Habilitado(ListaPerfUsr, Convert.ToString(row["menuaccess"])))
                ...
                if (Habilitado)
                {
                    ...
                    {
                        SalidaAyuda += " <LI style=''><a> ";                                               

                        
                        //SalidaAyuda += "<img src='img/Modulos/SVG/" + NombreModulo + ".svg' align='absmiddle'  class='IconosBarraTop' > ";
                        SalidaAyuda += Utils.Armar_Icono("img/Modulos/SVG/" + NombreModulo + ".svg", "IconosBarraTop", "", "align='absmiddle'", "");
                        SalidaAyuda += " </a>";
                    ...
                    if (!String.IsNullOrEmpty(Convert.ToString(row["MenuName"])))
                    {
                        ...
                        if (Convert.ToString(row["action"]) != "#")
                          Salida += " onclick =\"" + Utils.ArmarAction(Convert.ToString(row["action"]), modulo, Convert.ToString(row["menumsnro"]), Convert.ToString(row["MenuRaiz"]), Convert.ToString(row["menunro"]), "") + "\"  ";
                           //Salida += " onclick =\"" + Utils.ArmarAction(Convert.ToString(row["action"]), modulo, Convert.ToString(row["menumsnro"]), Convert.ToString(row["menudesc"]), Convert.ToString(row["menunro"])) + "\"  ";
        ...
        public string TopeModulo(Boolean QuitarScroll,string Titulo,int gnro, string detalle,int AnchoFull,int AltoFull, int gadtipo)
        {
           ...
           // Tope += "  <td style='vertical-align:middle !important; text-align:right; padding-right:3px; '  nowrap>";
            ...
            if (Utils.IsUserLogin)
            {
                ...
                //Tope += "<span class='BotonCabeceraGadget'><img src='~/../img/Modulos/SVG/EXPANDEALTO.svg' border='0' class='IconoModuloGadget' onclick='ExpandirAltura(" + gnro + "," + AltoFull + "," + gadtipo + ")' title='" + ObjLenguaje.Label_Home("Ajustar Alto") + "' > </span>   ";
                //Tope += "<span class='BotonCabeceraGadget'><img src='~/../img/Modulos/SVG/EXPANDEANCHO.svg' border='0' class='IconoModuloGadget' onclick='ExpandirAncho(" + gnro + "," + AnchoFull + "," + gadtipo + ")' title='" + ObjLenguaje.Label_Home("Ajustar Ancho") + "' >  </span>    ";
                //Tope += "<span class='BotonCabeceraGadget'><img src='~/../img/Modulos/SVG/UP.svg' border='0' class='IconoModuloGadget' onclick='Subir(" + gnro + ")' title='" + ObjLenguaje.Label_Home("Subir") + "' >   </span>   ";
                //Tope += "<span class='BotonCabeceraGadget'><img src='~/../img/Modulos/SVG/DOWN.svg' border='0' class='IconoModuloGadget' onclick='Bajar(" + gnro + ")' title='" + ObjLenguaje.Label_Home("Bajar") + "' >   </span>   ";
                //Tope += "<span class='BotonCabeceraGadget'><img src='~/../img/Modulos/SVG/APAGAR.svg' border='0' class='IconoModuloGadget'  onclick=\"Desactivar(" + gnro + ",'" + ObjLenguaje.Label_Home("Deséa desactivar el control?") + "')\" title='" + ObjLenguaje.Label_Home("Desactivar") + "' >  </span>    ";
                Tope += "<span class='BotonCabeceraGadget'>" + Utils.Armar_Icono("~/../img/Modulos/SVG/EXPANDEALTO.svg", "IconoModuloGadget", ObjLenguaje.Label_Home("Ajustar Alto"), " border='0'  onclick='ExpandirAltura(" + gnro + "," + AltoFull + "," + gadtipo + ")' ", "") + "</span>   ";
                Tope += "<span class='BotonCabeceraGadget'>" + Utils.Armar_Icono("~/../img/Modulos/SVG/EXPANDEANCHO.svg", "IconoModuloGadget", ObjLenguaje.Label_Home("Ajustar Ancho"), " border='0'  onclick='ExpandirAncho(" + gnro + "," + AnchoFull + "," + gadtipo + ")' ", "") + " </span>    ";
                Tope += "<span class='BotonCabeceraGadget'>" + Utils.Armar_Icono("~/../img/Modulos/SVG/UP.svg", "IconoModuloGadget", ObjLenguaje.Label_Home("Subir"), " border='0'  onclick='Subir(" + gnro + ")' ", "") + "   </span>   ";
                Tope += "<span class='BotonCabeceraGadget'>" + Utils.Armar_Icono("~/../img/Modulos/SVG/DOWN.svg", "IconoModuloGadget", ObjLenguaje.Label_Home("Bajar"), " border='0'  onclick='Bajar(" + gnro + ")' ", "") + "   </span>   ";
                Tope += "<span class='BotonCabeceraGadget'>" + Utils.Armar_Icono("~/../img/Modulos/SVG/APAGAR.svg", "IconoModuloGadget", ObjLenguaje.Label_Home("Desactivar"), " border='0'  onclick=\"Desactivar(" + gnro + ",'" + ObjLenguaje.Label_Home("Deséa desactivar el control?") + "')\" ", "") + "</span>    ";
        ...
        public string CabeceraAccesos(String desabr, String accion, bool isLogin)
        {
            ...
            if (isLogin == true)
            {
                if (Common.Utils.IsUserLogin)
                {
                    ...
                    TopeInfo += Utils.Armar_Icono("img/modulos/SVG/APERTURA_MODULO.svg", "IconoModuloGadget", "", "align='absmiddle' style = 'cursor:pointer; '", "") + " </span>";
