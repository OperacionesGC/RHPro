...
<!-- Busco los accesos  -->           
  <asp:Repeater ID="RepAccesos" runat="server"  >
           ...
           <tr id='Link<%=posmenu %>' onclick="Seleccionar('Link<%=posmenu %>','')"      > 
                    ...
                    <td>     
                      <asp:LinkButton ID="LinkButton2"   OnCommand="Actualizar_Accesos_XML"  CommandArgument='<%#(String)Eval("nroAcceso")%>'
                         runat="server" CssClass="ASPlink"   >                           
                           <DIV style=" width:200px;">  
                             <% posmenu++; %>                                                           
                    ...
                    <td align='right'> 
                        <%# ImprimirLink(Boolean.Parse((String)Eval("isLogin")), (String)Eval("URL"))%>                    
