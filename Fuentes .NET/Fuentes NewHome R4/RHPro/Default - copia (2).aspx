...
*/
    ...
    if (obj.style.width == "30px")
        obj.style.width = "245px";
    else
 ...
 <% } %>
  ...
  <tr>
    ...
    <%  }
       ...
       { %> 
        <td   align="left" valign="top" width="100%"  style="height:250px; background-color:#FFFFFF; background:url(img/mesaOval_FondoRayos.jpg)  top left; " > 
    <% } %>
                ...
                <tr>
                   ...
                   <td class="DetRedes" nowrap valign="top">
                    ...
                    <td width="52%" rowspan="2" valign="bottom" align="right" style="height:70px; padding:4px;" nowrap>
                      ...
                      <img src="img/LogoRHPro_MARCADO.png" width="110" style="margin-bottom:4px;" ></img>
