...
<%#Armar_Link_MRU((string)Eval("menuaccess"),(int)Eval("menumsnro"),(string)Eval("action"),(int)Eval("menuraiz"),(int)Eval("menunro"),(string)Eval("menuname"),(int)Eval("mrucant"),(string)Eval("menudir"),(string)Eval("menudesc")) %>
