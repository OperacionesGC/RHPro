...
(function($) {
	...
	$.extend($.SmartMenus, {
		...
		prototype: {
			...
			menuScrollMousewheel: function($sub, e) { 
				...
				//alert($closestSub.dataSM('in-mega'));
				...
				if ($closestSub[0] == $sub[0]) {
					...
					//Verifica si esta scroleando hacia arriba o hacia abajo
					var up = (e.originalEvent.wheelDelta || -e.originalEvent.detail) > 0;				
					
					//alert(e.originalEvent.wheelDelta);
					//JPB - Habilita el scroll                    
	...
	$.fn.smartmenus.defaults = {
		...
		hideTimeout:		800,		// timeout before hiding the sub menus
		...
		hideDuration:		100,		// duration for hide animation - set to 0 for no animation - matters only if hideFunction:null
