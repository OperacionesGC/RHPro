...
//       public static Login Find(string userName, string password, string encryptionKey, Utils.IntegrateSecurityConstants integrateSecurity, string dataBaseID, bool? encriptUserData, string idioma, String AUTH_USER, String REMOTE_ADDR)
       public static Login Find(string userName, string password, string encryptionKey, Utils.IntegrateSecurityConstants integrateSecurity, string dataBaseID, bool? encriptUserData, string idioma, String AUTH_USER, String REMOTE_ADDR
           ,bool camposvalidos, int DiasBloqueo)
        {
           ...
           Login LoginToReturn = null;
            ...
            //DataTable dataBases = consultas.Login(userName, password, integrateSecurity.ToString(), dataBaseID, idioma, AUTH_USER, REMOTE_ADDR);
           DataTable dataBases = consultas.Login(userName, password, integrateSecurity.ToString(), dataBaseID, idioma, AUTH_USER, REMOTE_ADDR
