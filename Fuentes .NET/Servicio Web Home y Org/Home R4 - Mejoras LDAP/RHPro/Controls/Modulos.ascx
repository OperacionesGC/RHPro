...
.Menu_Ppal TR { color:#FFF; font-family:Tahoma; font-size:11pt; background:url(img/Fondo_Menu.png) repeat-x top; height:25px; cursor:pointer }
.Menu_Links TR { color:#FFF; font-family:Tahoma; font-size:9pt; background:url(img/Fondo_Menu.png) repeat-x top; height:27px; cursor:pointer }
 
.ASPlink 
{ 
 background-color:transparent; text-decoration:none; font-family: Tahoma; font-size:10pt; color:#FFFFFF; 
 cursor: pointer;
}
