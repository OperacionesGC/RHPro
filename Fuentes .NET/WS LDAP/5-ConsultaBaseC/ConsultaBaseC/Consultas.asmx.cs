    ...
    { 
        ...
        public string VersionWS()
        {
            ...
            */
            ...
            //1.17
            Salida = "30/08/2013 - Carlos Masson - 19483 - Mejoras en la performance con LDAP. Requiere configurar el usuario del directorio con el que se realiza la búsqueda ";
...
*/
        ...
        public DataTable TablaPlanaErecruiting(string Tabla, string Base)
        {
            ...
            /*
ORIGENES : SEXO
ORIGENES : TIPOS_ESTUDIOS
ORIGENES : TITULOS
ORIGENES : INSTITUCIONES
ORIGENES : PAISES
ORIGENES : TIPOS_DOCUMENTOS
ORIGENES : IDIOMAS
ORIGENES : PROVINCIAS
ORIGENES : PUESTOS
ORIGENES : CONOCIMIENTOS----
ORIGENES : NACIONALIDADES
            */
            ...
            switch (Tabla.ToUpper())
            {
                ...
                case "SEXO":
                    ...
                    break;
                case "TIPOS_ESTUDIOS":
                    sql = "  select nivest.nivnro cod, nivest.nivdesc descr from nivest ";
                    break;                    
                case "TITULOS":
                    sql = " select titulo.titnro cod,titulo.titdesabr descr from  titulo ";
                    break;
                case "INSTITUCIONES":
                    sql = "  select institucion.instnro cod, institucion.instdes descr from  institucion ";
                    break;
                case "PAISES":
                    sql = "SELECT pais.paisnro cod, pais.paisdesc descr FROM pais";
                    break;
                case "TIPOS_DOCUMENTOS":
                    sql = " select tipodocu.tidnro cod, tidsigla descr from  tipodocu ";
                    break;
                case "IDIOMAS":
                    sql = "  select idioma.idinro cod,idioma.ididesc descr from idioma ";
                    break;
                case "PROVINCIAS":
                    sql = " select provincia.provnro cod,provincia.provdesc descr from provincia ";
                    break;
                case "PUESTOS":
                    sql = " select recPUESTO.estrnro cod, recPUESTO.puestonro descr from recPUESTO ";
                    break;                     
                case "NACIONALIDADES":
                    sql = " select nacionalidad.nacionalnro cod, nacionalidad.nacionaldes descr from  nacionalidad ";
                    break;
