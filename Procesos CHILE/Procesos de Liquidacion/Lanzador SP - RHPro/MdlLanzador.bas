...
'Const Version = 1.01
'Const FechaVersion = "29/12/2011" ' Juan A. Zamarbide
        
'Const Version = 1.02
'Const FechaVersion = "29/02/2012" ' Juan A. Zamarbide
                                  ' Se modificó el Lanzador para recibir los parámetros del proceso de Asiento Contable
        
Const Version = 1.03
Const FechaVersion = "02/03/2012" ' Lisandro Moro

        
Global Volcod As Integer
...
On Error GoTo MAINE
    ...
    StrSql = "SELECT * FROM batch_proceso WHERE btprcnro = 363 AND bpronro =" & NroProcesoBatch
...
objCmd.CommandText = "sp_Asiento_Contable"
...
Flog.writeline objCmd.CommandText & " - " & Volcod & " - " & NroProcesoBatch & " - " & Empresa

'Inserto los Parámetros
objCmd.Parameters.Append objCmd.CreateParameter("@Volcod", adInteger, adParamInput, 0, Volcod)
objCmd.Parameters.Append objCmd.CreateParameter("@BatchNumProc", adInteger, adParamInput, 0, NroProcesoBatch)
...
If Not IsNull(parametros) Then
    ...
    If Len(parametros) >= 1 Then
        ...
        Volcod = CInt(Mid(parametros, pos1, pos2))
