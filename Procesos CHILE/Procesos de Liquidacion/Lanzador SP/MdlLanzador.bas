...
StrSql = "UPDATE batch_proceso SET bprcprogreso = 50.0000  WHERE bpronro = " & NroProcesoBatch
objconnProgreso.Execute StrSql, , adExecuteNoRecords


'Inserto los Parámetros
objCmd.Parameters.Append objCmd.CreateParameter("@Mes", adInteger, adParamInput, 0, Mes)
objCmd.Parameters.Append objCmd.CreateParameter("@Ano", adInteger, adParamInput, 0, Anio)
