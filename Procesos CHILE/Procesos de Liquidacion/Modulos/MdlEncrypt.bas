...
'Encriptar un string
Public Function Encryptar(ByVal strEncryptionKey, ByVal strTextToEncrypt)
    ...
    Encryptar = strTextToEncrypt
End Function


'Desencriptar un string
Public Function Decryptar(ByVal strEncryptionKey, ByVal strTextToEncrypt)
    Dim outer, inner, Key, strTemp, buffer
