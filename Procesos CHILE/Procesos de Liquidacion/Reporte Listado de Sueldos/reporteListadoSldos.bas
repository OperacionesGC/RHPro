...
'Global Const FechaModificacion = "17/03/2008"
'Global Const UltimaModificacion = " " FGZ - Se cambió la forma de calculo de la columna 7 (TICKETS)

Global Const Version = "1.03"
Global Const FechaModificacion = "04/09/2009"
...
'    ' FGZ - 17/03/2008 -
'    ' Todo este calculo se va a reemplazar por la liquidacion simplemente buscar un concepto liquidado
'    '---------------------------------------------------------------------------------
'    ' Columna 7 - Tickets
...
'    '---------------------------------------------------------------------------------
    ...
    ' FGZ - 17/03/2008 - Nuevo Calculo
    '---------------------------------------------------------------------------------
    ' Columna 7 - Tickets
    ' no hago nada pues Columnas(10).Valor ya contiene el valor de los conceptos configurados en la columna
    '
    ' FGZ - 17/03/2008 - Nuevo Calculo
    '---------------------------------------------------------------------------------
