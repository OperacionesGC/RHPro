...
Global cautoevaluador As Integer
Global cevaluador As Integer
Global cgarante As Integer
...
Global Monto As Single
Global Retro As Date
Global Bien As Boolean
Global AFecha As Date

Global Valor_Ampo As Single
Global Valor_Ampo_Cont As Single

Global Cant_Diaria_Ampos_1 As Single
Global Cant_Diaria_Ampos_2 As Single
Global Cant_Diaria_Ampos_3 As Single
Global Cant_Diaria_Ampos_4 As Single
Global Cant_Diaria_Ampos_5 As Single

Global Cant_Ampo_Proporcionar_1 As Single
Global Cant_Ampo_Proporcionar_2 As Single
Global Cant_Ampo_Proporcionar_3 As Single
Global Cant_Ampo_Proporcionar_4 As Single
Global Cant_Ampo_Proporcionar_5 As Single
...
Global Ampo_Max_1 As Single
Global Ampo_Max_2 As Single
Global Ampo_Max_3 As Single
Global Ampo_Max_4 As Single
Global Ampo_Max_5 As Single

Global Ampo_Min_1 As Single
Global Ampo_Min_2 As Single
Global Ampo_Min_3 As Single
Global Ampo_Min_4 As Single
Global Ampo_Min_5 As Single
...
Global pliqdesde As Integer
Global pliqhasta As Integer
Global Concepto_Retroactivo As Integer
Global concepto_pliqdesde As Integer
Global concepto_pliqhasta As Integer

'Global Monto_Proratear As Single
...
Global Cantidad_de_Conceptos As Integer
Global Concepto_Actual As Integer
...
Global Indice_Actual As Integer

Global Arr_Cge_Segun() As TCge_Segun
'Mantiene el indice actual del cge_Segun
Global Indice_Actual_Cge_Segun As Integer

Global Arr_Cft_Segun() As TCft_Segun
'Mantiene el indice actual del cge_Segun
Global Indice_Actual_Cft_Segun As Integer

Global Buliq_Concepto() As Tbuliq_concepto
'Mantiene el indice actual de buliq_concepto
Global Indice_Buliq_Concepto As Integer

Global Arr_For_Tpa() As TFor_tpa
'Mantiene el indice actual del For_Tpa
Global Indice_Actual_For_Tpa As Integer

Global Arr_Acumulador() As TAcumulador
'Mantiene el indice actual del Acumulador
Global Acumulador_Actual As Integer

Global Cantidad_de_OpenRecordset As Long
Global Borrar_Estadisticas As Boolean

'Indices Maximos de los arreglos globales
Global Max_Conceptos As Integer
Global Max_Cabeceras As Integer
Global Max_Programas As Integer
Global Max_Con_For_Tpa As Integer
Global Max_Cge_Segun As Integer
Global Max_Cft_Segun As Integer
Global Max_For_Tpa As Integer
Global Max_Acumuladores As Integer
...
Global Arr_Con_Acum() As Integer
