...
Dim objRs As New ADODB.Recordset
    ...
    Case 3 ' sql server
          ...
          StrSql = "SELECT SCOPE_IDENTITY() as Codigo "   'ESTE NO ANDA!!
       '     StrSql = "SELECT SCOPE_IDENTITY() as Codigo FROM " & NombreTabla & ""
    ...
    If Not (objRs.EOF And objRs.BOF) Then
        ...
        If Not EsNulo(objRs.Fields("codigo").Value) Then '  Print ' !!!!!!!!!!!!
