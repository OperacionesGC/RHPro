...
Dim EncAcuImp As Boolean
    ...
    Do While Not rs_Periodos.EOF
        ...
        End If
        If CBool(USA_DEBUG) Then
            Flog.writeline Espacios(Tabulador * 4) & "Deduccion Hist Ajus (Cptos Reliq): " & FormatNumber(DeduccHist, 2)
        End If
        
        'Buscar en impunicab el imponible anterior usado en la escala por el recalculo de IU
        ImpoAntRecalc = 0
        ...
        If CBool(USA_DEBUG) Then
            Flog.writeline Espacios(Tabulador * 4) & "Imponible Periodo + Bono Ajustado: " & FormatNumber(ImpoHistBono, 2)
            Flog.writeline Espacios(Tabulador * 4) & "Nuevo Imponible (Imp Per + Bono - Deducc Hist: " & FormatNumber(NuevoImpoMesHist, 2)
        End If
        ...
        If Not rs_consult.EOF Then
            ...
            If CBool(USA_DEBUG) Then
                Flog.writeline Espacios(Tabulador * 4) & "Entra en escala con: " & FormatNumber(Abs(NuevoImpoMesHist), 2)
