...
Case 1: ' DB2
        ...
        Case "WF_AD", "#WF_AD":
            cadena = TTempWFAd & "(thnro integer,Cant_hs double,Acumula integer)"
        Case "WF_LECTURAS", "#WF_LECTURAS":
...
Case 2: ' Informix
        ...
        Case "WF_AUSPA", "#WF_AUSPA":
            cadena = TTempWFAuspa & "(fecha date,hora char(4),par integer)"
        Case "WF_AD", "#WF_AD":
            cadena = TTempWFAd & "(thnro integer,Cant_hs decimal(5,2),Acumula integer)"
        Case "WF_LECTURAS", "#WF_LECTURAS":
            cadena = TTempWFLecturas & "(ternro integer,fecha Date)"
        End Select
...
Case 4: ' Oracle 9
        ...
        Case "WF_AD", "#WF_AD":
            cadena = TTempWFAd & "(thnro double precision,Cant_hs FLOAT(63),Acumula double precision)"
        Case "WF_LECTURAS", "#WF_LECTURAS":
