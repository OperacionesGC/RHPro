...
'Const Version = "1.13"
'Const FechaVersion = "20/07/2010"   'Brzozowski Juan Pablo
'                               Modificaciones:
'                                Se configuró la autentificación de Email para que acepte el usuario "anonymous"


Const Version = "1.14"
Const FechaVersion = "02/05/2012"   'Masson Carlos
'                               Modificaciones: Caso 15775
'                                Se compilo el ejecutable con la versioón de mdlDataAccess actualizada ya que no leia el schema en cargarConfiguraciones Basicas
...
'       Si el usuario es anonymous, caso contrario valida
        If (MailUser = "anonymous") Then
'         0 = AuthNone, 1 = AuthPOP, 2 = AuthLogin, 3 = AuthPlain
