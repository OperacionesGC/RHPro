...
'Empresa
Global Aux_Empresa_ternro As String
Global Aux_Empresa_Cuit As String
Global Aux_Empresa_RazonSocial As String
Global Aux_Empresa_DMTRCalle As String
Global Aux_Empresa_DMTRNum As String
Global Aux_Empresa_DMTRPiso As String
Global Aux_Empresa_DMTRDepto As String
Global Aux_Empresa_DMTRCodPost As String
Global Aux_Empresa_DMTRLoc As String
Global Aux_Empresa_DMTRProv As String
Global Aux_Empresa_TelefonoLab As String


'Empleado
Global Aux_Empleado_ternro As String
Global Aux_Empleado_CUIL As String
Global Aux_Empleado_Nombres As String
Global Aux_Empleado_TipoNroDoc As String
Global Aux_Empleado_Sexo As String
Global Aux_Empleado_FecNac As String
Global Aux_Empleado_EstadoCivil As String
Global Aux_Empleado_DOMCalle As String
Global Aux_Empleado_DOMNro As String
Global Aux_Empleado_DOMPiso As String
Global Aux_Empleado_DOMDto As String
Global Aux_Empleado_DOMCodPost As String
Global Aux_Empleado_DOMLocalidad As String
Global Aux_Empleado_DOMProvincia As String
Global Aux_Empleado_Telefono As String
Global Aux_Empleado_OSElegida As String
Global Aux_Empleado_FecIngreso As String
Global Aux_Empleado_ABM As String



'Familiar
Global Aux_Familiar_Parentesco As String
Global Aux_Familiar_CUIL As String
Global Aux_Familiar_Nombres As String
Global Aux_Familiar_TipoNroDoc As String
Global Aux_Familiar_FecNac As String
Global Aux_Familiar_Sexo As String
Global Aux_Familiar_EstadoCivil As String
Global Aux_Familiar_Incapacidad As String
Global Aux_Familiar_DOMCalle As String
Global Aux_Familiar_DOMNro As String
Global Aux_Familiar_DOMPiso As String
Global Aux_Familiar_DOMDto As String
Global Aux_Familiar_DOMCodPost As String
Global Aux_Familiar_DOMLocalidad As String
Global Aux_Familiar_DOMProvinc As String
Global Aux_Familiar_Telefono As String
Global Aux_Familiar_Aniocursa As String
Global Aux_Familiar_Genderasigf As String ' Si/No
Global Aux_Familiar_Escolaridad As String 'General basica, polimodal o no informa
Global confval_1 As Integer
Global confval_2 As Integer


'Registros
Global rs_Empresa As New ADODB.Recordset
Global rs_Empleados As New ADODB.Recordset
Global rs_Familiares As New ADODB.Recordset
Global rs_batch_empleado As New ADODB.Recordset
Global rs_repnro As New ADODB.Recordset
Global rs_Confrep As New ADODB.Recordset
Global rs_Estudio As New ADODB.Recordset
Global rs_confval As New ADODB.Recordset
Global Aux_Familiar_ternro As String
Global Aux_Familiar_empleado As String
Global Aux_Familiar_repnro As String
Global Aux_repnro As String
Global queryEmpleado As String
