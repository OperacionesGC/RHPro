...
( 
  ...
  primary key (tipfacnro) constraint pk_anrtipofact
);
...
( 
  ...
  primary key (facnro) constraint pk_anrfactor
);
...
(
 ...
 primary key (anrcabnro) constraint pk_anrcab
);
...
( 
 anrrangnro serial not null,
 anrcabnro integer not null,
 anrrangorden integer,
 anrrangdesabr varchar(30),
 anrrangfecdesde date,
 anrrangfechasta date,
 primary key (anrrangonro) constraint pk_anrrangofec
);
