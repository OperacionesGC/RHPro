...
'Ult Modif: FGZ - 22/05/2012 - se cambió la forma de validar si corresponde convertir o no
'------------------------------------------------------------------------------
...
If Not objrsHC.EOF Then
    ...
    Do While Not objrsCFG_H.EOF
        'FGZ - 22/05/2012 --------- Se cambió la forma de validar si corresponde convertir o no ---------
        If (esFeriado And objrsCFG_H!hd_feriados) Or (Dia_Libre And objrsCFG_H!hd_nolaborables) Or (Not Dia_Libre And objrsCFG_H!hd_laborable) Then
                Horas_Acum = 0
                Horas_Acum_HS = "00:00"
