Attribute VB_Name = "mdlConversionesv2"
Option Explicit
...
If Not objrsHC.EOF Then
    ...
    StrSql = "SELECT hd_nro, hd_thorigen, hd_thdestino,hd_feriados,hd_nolaborables,hd_laborable,hd_franja,hd_alcance,ws_diassem FROM gti_config_horadia " & _
            " WHERE hd_thorigen = " & objrsHC!thnro & " AND  turnro = " & P_NroTur & " AND hd_ordenproc = 1 AND ( hd_programa is null OR hd_programa = '') ORDER BY hd_nro"
                ...
                Else
                    ...
                    Else
                        ...
                        If acumula Then
                            ...
                            End If
                        Else
                            'EAM- Entra si no acumula las hs
        ...
        If arrTempHsAD(i).acumula = -1 Then
            ...
            If horas_conv <> 0 Then
                ...
                Else
                    ...
                    arrTempHsAD(auxPosHsADTemp).Horas = Horas_Acum_HS
...
'             " AND ( hd_programa is null OR hd_programa = '') ORDER BY hd_nro"
    StrSql = "SELECT hd_thorigen, hd_thdestino,hd_feriados,hd_nolaborables,hd_laborable,hd_franja FROM gti_config_horadia " & _
            " WHERE hd_thorigen = " & objrsHC!thnro & " AND  turnro = " & P_NroTur & " AND ( hd_programa is null OR hd_programa = '') ORDER BY hd_nro"
    OpenRecordset StrSql, objRsConfig
...
Do While Not objRsCFG.EOF
    ...
    If UCase(objRsCFG!hd_programa) = UCase("NOC_Sykes_CR") Then
        'Chequeo que las horas que hizo el empleado esten dentro del minimo y maximo configurado para la conversion
        If (objRsCFG!adcanthoras <= objRsCFG!hd_maximo) And (objRsCFG!adcanthoras >= objRsCFG!hd_minimo) Then
    ...
    'SABADOS ------------------------------------------------------------------------------
    If UCase(objRsCFG!hd_programa) = UCase("SABADOS") Then
