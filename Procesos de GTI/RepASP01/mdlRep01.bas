...
'Global Const Version = "1.02" ' Diego Nuñez
'Global Const FechaVersion = "13/08/2009"
'Global Const UltimaModificacion = ""    'Se almacena en la base el filtro del reporte


'Const Version = "4.00"
'Const FechaVersion = "18/05/2010"
''Modificaciones: FGZ
''    Cambios Importantes
''        ALTER table rep_asp_01 add horastr varchar(10) null default ‘0:00’

Const Version = "4.01"
Const FechaVersion = "31/08/2010"
'Modificaciones: FGZ
'    ValidarV(). No estaba escribiendo en el log cuando la version del proceso es incompatible.
...
Dim ArrParametros
    ...
    Version_Valida = ValidarV(Version, 17, TipoBD)
...
HorasAusencia = ""
Call BuscarTodasLasHorasAusencia(HorasAusencia)
...
Do Until rs.EOF
    StrSql = ""
    'HorasAusencia = ""
    'Call BuscarTodasLasHorasAusencia(l_desde, l_hasta, rs("ternro"), HorasAusencia)
    ...
    If Not rs2.EOF Then
        ...
        Do Until (l_fecha = CDate(l_hasta) + 1)
            ' busco los tipo de hora ausencia
            'HorasAusencia = ""
            'Call BuscarHorasAusencia(l_fecha, rs("ternro"), HorasAusencia)
...
'                        StrSql = "INSERT INTO rep_asp_01 (bprcnro,repnro,ternro,Fecha,causa,descripcion, TipoJust, CodJust,Filtro) VALUES (" & _
'                        NroProceso & "," & NroReporte & "," & rs("ternro") & "," & ConvFecha(l_fecha) & ",'" & rs2("tipo") & "','" & Left(rs2("descripcion"), 25) & "'," & rs2("TipoJust") & "," & rs2("CodJust") & ",'" & l_filtro & "')"
                        StrSql = "INSERT INTO rep_asp_01 (bprcnro,repnro,ternro,Fecha,causa,descripcion,horastr,horas, TipoJust, CodJust,Filtro) VALUES (" & _
                        NroProceso & "," & NroReporte & "," & rs("ternro") & "," & ConvFecha(l_fecha) & ",'" & rs2("tipo") & "','" & Left(rs2("descripcion"), 25) & "','0:00',0," & rs2("TipoJust") & "," & rs2("CodJust") & ",'" & l_filtro & "')"
                    Else
                        'FGZ - 17/05/2010 ----------------
                        'StrSql = "INSERT INTO rep_asp_01 (bprcnro,repnro,ternro,Fecha,causa,descripcion,horas, TipoJust, CodJust,Filtro) VALUES (" & _
                        'NroProceso & "," & NroReporte & "," & rs("ternro") & "," & ConvFecha(l_fecha) & ",'" & rs2("tipo") & "','" & Left(rs2("descripcion"), 25) & "'," & rs2("horas") & "," & rs2("TipoJust") & "," & rs2("CodJust") & ",'" & l_filtro & "')"
                        
                        TotHorHHMM = CHoras(rs2("horas"), 60)
                        'FGZ - 17/05/2010 ----------------
                        StrSql = "INSERT INTO rep_asp_01 (bprcnro,repnro,ternro,Fecha,causa,descripcion,horastr,horas, TipoJust, CodJust,Filtro) VALUES (" & _
                        NroProceso & "," & NroReporte & "," & rs("ternro") & "," & ConvFecha(l_fecha) & ",'" & rs2("tipo") & "','" & Left(rs2("descripcion"), 25) & "'," & TotHorHHMM & "," & rs2("horas") & "," & rs2("TipoJust") & "," & rs2("CodJust") & ",'" & l_filtro & "')"
                    End If
                    objConn.Execute StrSql, , adExecuteNoRecords
