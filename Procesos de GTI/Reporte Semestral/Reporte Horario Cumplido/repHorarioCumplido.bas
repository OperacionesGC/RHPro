...
End Function
Function Horas(ByVal ths, ByVal Etiqueta, ByVal Ternro, ByVal Fecha, ByVal relnro, ByVal cont)
    Dim l_salida
    Dim l_sql As String
    Dim StrSql As String
    Dim sql As String
    ...
    If cont <= 10 Then
        ...
        StrSql = " UPDATE rep_horariocumplidodet set campo" & cont & " = '" & Etiqueta & "', valor" & cont & "=" & valor
...
Function Fichadas(ByVal ths, ByVal Ternro, ByVal Fecha, ByVal relnro)
    ...
    If Not rsconsult.EOF Then
        ...
        Do While Not rsconsult.EOF
           ...
           End If
            l_salida = l_salida & rsconsult!regentsal & "," & rsconsult!reghora & "," & l_auto & "," & l_recha & "@"
        rsconsult.MoveNext
        Loop
        'Firmadas
        'l_salida = ""
...
If firmas = "-1" Then 'autorizadas
    l_sql_from = "LEFT JOIN cysfirmas ON gti_registracion.regnro = cysfircodext "
...
End If
    ...
    StrSql = StrSql & " AND horfecgen >= " & ConvFecha(fdesde) & " AND horfecgen <= " & ConvFecha(fhasta)
    ...
    Do While Not rsconsult.EOF
        ...
        Call Fichadas(1, rsconsult!Ternro, ConvFecha(rsconsult!horfecrep), rsconsult!relnro)
        ...
        Do While Not rsconsult1.EOF
            cont = cont + 1
            Call Horas(rsconsult1!confval, rsconsult1!confetiq, rsconsult!Ternro, ConvFecha(rsconsult!horfecrep), rsconsult!relnro, cont)
            rsconsult1.MoveNext
        Loop
        rsconsult1.Close
