...
Global Const FechaVersion = "05/05/2015" ' Fernandez Matias - CAS-21778 - Sykes El Salvador - QA - Bug Giv1
                                          'Se modifico la funciona del modelo 7 el salvador para que llame Licencias3() igual que argentina ya que usa el complemento de vacaciones
                                          'filtra los periodos por ternro
