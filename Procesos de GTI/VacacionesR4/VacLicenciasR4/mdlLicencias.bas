...
Dim objModVac As New ADODB.Recordset
...
Dim arrPar
    ...
    If Not IsNull(parametros) Then
        If Len(parametros) >= 1 Then
            ...
            Else
                ...
                Autorizadas = CBool(arrPar(3))
                Firma_User_Destino = arrPar(4)
                vacmodelo = arrPar(5)
    ...
    'MDZ - 05-06-2015 - se clava a Argentina para todos,
    'luego habra que en base a la configuracion del modelo hacer las diferencias necesarias
    'modeloPais = 0
    
    Dim rsModeloVac As New ADODB.Recordset
    Select Case modeloPais
            Case 0 To 3: 'Argentina '--------------------------------------------------------------------------------------------------------------------
                ...
                Do While Not objReg.EOF
                    ...
                    '15/02/2016 - MDZ - levanto los periodos de vacaciones
                     If objModVac("modvactipoperiodo") = 1 Then
                         ...
                         StrSql = "SELECT " & _
                                 ...
                                 " From vacacion " & _
                                 " WHERE vacmodelo=" & vacmodelo & " AND (select MIN(vdetfdesde) from vacacion_detalle vd where vd.vacnro = vacacion.vacnro and vd.vdetfdesde<= " & ConvFecha(fecha_hasta) & " AND vd.vdetfhasta>= " & ConvFecha(fecha_desde) & " and ternro= 0) is not null"
                     ...
                     ElseIf objModVac("modvactipoperiodo") = 2 Then
                         ...
                         StrSql = "SELECT " & _
                                 ...
                                 " ,vacacion.vacdesc, vacacion.vacnro  " & _
                                 " From vacacion " & _
                                 " WHERE vacmodelo=" & vacmodelo & " AND (select MIN(vdetfdesde) from vacacion_detalle vd where vd.vacnro = vacacion.vacnro and vd.vdetfdesde<= " & ConvFecha(fecha_hasta) & " AND vd.vdetfhasta>= " & ConvFecha(fecha_desde) & " and ternro= " & Ternro & " ) is not null"
                   ...
                   'FGZ - 24/06/2009 -------
                    ...
                    Do While Not rs_Periodos_Vac.EOF
                        ...
                        MyBeginTrans
                        fecha_desde = rs_Periodos_Vac!vacfecdesde
                        fecha_hasta = rs_Periodos_Vac!vacfechasta
                        ...
                        Call Licencias4(NroVac, Ternro, Autorizadas)
...
'siguiente7:
            ...
            Case 8 'Peru
                Flog.writeline "Modelo de vacaciones de Perú." & modeloPais
...
Private Sub Licencias4(NroVac As Long, Ternro As Long, ByVal Autorizadas As Boolean)
Dim hay_licencia As Boolean
Dim NroTipVac As Long
...
'    OpenRecordset StrSql, rs_Vacdiasped
    ...
    Do While Not rs_Vacdiasped.EOF
        'EAM- Seteo el vacnro a cual corresponde el pedido
        NroVac = rs_Vacdiasped!vacnro
...
Dim Estrnro_SitRev As String
    ...
    If rs_existeLic.EOF Then
        ...
        If activo(Ternro, fechadesde, FechaHasta) Then
            ...
            StrSql = "update emp_lic set lic_ant= emp_licnro where emp_licnro=" & nroEmpLic
            objConn.Execute StrSql, , adExecuteNoRecords
