...
Dim Periodo_Anio As Long
    ...
    If Not IsNull(parametros) Then
        ...
        vacmodelo = CLng(ArrPar(6))
        'LM - en el proceso de colombia llega en nrovac = 0
        If NroVac <> 0 Then
            StrSql = " SELECT vacacion.vacanio, vd.vdetfdesde,vd.vdetfhasta FROM vacacion " & _
                    " INNER JOIN vacacion_detalle vd on vd.vacnro = vacacion.vacnro" & _
                    " Where vacacion.vacnro = " & NroVac
            OpenRecordset StrSql, objRs
            If Not objRs.EOF Then
                Periodo_Anio = objRs!vacanio
                fecha_desde = objRs!vdetfdesde
                fecha_hasta = objRs!vdetfhasta
            End If
        End If
         ...
         If CalculaVencimientos Then
            Select Case modeloPais
                ...
                Case Else '0: Argentina - 1: chile - 2:uruguay
                    ...
                    NroVacSiguiente = PeriodoCorrespondienteR4(Periodo_Anio, vacmodelo)
