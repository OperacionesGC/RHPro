...
If Not rs_Alcance.EOF Then
    ...
    If Not rs_TipoDistribucion.EOF Then
        ...
        Else
            Flog.writeline Espacios(Tabulador * 4) & "Razon de 30 días "
        End If
        Flog.writeline Espacios(Tabulador * 4) & "Logica de Distribución " & LogicaDistribucion
...
Do While Not rs_Detliq.EOF
    ...
    If TipoE1 <> 0 Then
        ...
        If rs_Estructura1.EOF Then
            Flog.writeline Espacios(Tabulador * 5) & "No se encontró ninguna estructura de tipo 1 entre " & FechaDesde & " y " & FechaHasta & ". Inserto el total"
            Aux_Desde = FechaDesde
            Aux_Hasta = FechaHasta
        ...
        Do While Not rs_Estructura1.EOF
            ...
            If TipoE2 <> 0 Then
                ...
                If rs_Estructura2.EOF Then
                    Flog.writeline Espacios(Tabulador * 6) & "No se encontró ninguna estructura de tipo 2 entre " & Aux_Desde & " y " & Aux_Hasta & ". Inserto el total"
                ...
                Do While Not rs_Estructura2.EOF
                    ...
                    If TipoE3 <> 0 Then
                        ...
                        If rs_Estructura3.EOF Then
                            Flog.writeline Espacios(Tabulador * 7) & "No se encontró ninguna estructura de tipo 3 entre " & Aux_Desde & " y " & Aux_Hasta & ". Inserto el total"
    ...
    'Reviso si quedó saldo
    Flog.writeline Espacios(Tabulador * 4) & "Reviso si quedó saldo "
