...
'Global Const FechaModificacion = "27/04/2010"   'Encriptacion de string connection
'Global Const UltimaModificacion = "Martin Ferraro"
'Global Const UltimaModificacion1 = "Creacion de todas las carpetas donde se genera el archivo"

Global Const Version = 1.07
Global Const FechaModificacion = "15/09/2014"   'Se verifica si viene la barra en el directorio de salida
Global Const UltimaModificacion = "Sebastian Stremel"
Global Const UltimaModificacion1 = "CAS-24538 - CCU - MEJORA EN SEGURIDAD EN IN-OUT"
'-----------------------------------------------------------------------------------
'-----------------------------------------------------------------------------------
'-----------------------------------------------------------------------------------
Global fs, f
