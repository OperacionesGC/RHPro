...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-33601 - RH Pro (Producto) - Peru - Interfaz modelo 922
...
'                                     'Se agregó el modelo 404 Importación de Seguros (Custom)
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-33601 - RH Pro (Producto) - Peru - Interfaz modelo 922
                                     'Se modificó función TraerTelefonosMask  Controla para teléfonos enmascarados en campo telnro

'Global Const Version = "6.27"
'Global Const FechaModificacion = "10/12/2015"
'Global Const UltimaModificacion = "" 'LED - CAS-28226 - Raffo - Interface Jefe y Jefe del Jefe (Roles de Evaluación)
                                     'Nuevo modelo 2009 - Roles de eventos

'Global Const Version = "6.26"
'Global Const FechaModificacion = "'10/12/2015"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-33601 - RH Pro (Producto) - Peru - Interfaz modelo 922
                                     '922 : Cód. telefónicos para PERU


'Global Const Version = "6.25"
'Global Const FechaModificacion = "'02/12/2015"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-33601 - RH Pro (Producto) - Peru - Interfaz modelo 922
                                     '922 : Se marcan como principales los teléfonos de tipo 1 (Sólo válido para PERU)
...
'Global Const UltimaModificacion = "" 'Miriam Ruiz - CAS-33789 - RHPro - Bug en interfaz 630
                                     'se corrigió para que no insertara dos planes duplicados
...
'Global Const UltimaModificacion = "" 'Miriam Ruiz - CAS-33601 - RH Pro (Producto) - Peru - Bug Estudios Formales
                                     'Se modificó la interfaz 296 para que no permita cargar dos carreras con el mismo nombre
                                

'Global Const Version = "6.22"
'Global Const FechaModificacion = "'13/11/2015"
'Global Const UltimaModificacion = "" 'Miriam Ruiz - CAS-33789 - RHPro - Bug en interfaz 630
                                     'Se modificó la interfaz 630 para que no permita cargar un plan de obra social si el empleado no tiene una obra social asignada
                                     

'Global Const Version = "6.21"
'Global Const FechaModificacion = "'10/11/2015"
'Global Const UltimaModificacion = "" 'Miriam Ruiz - CAS-33972 - BDO Perú - Bug Asignación Nro. Empleados
                                     'Se agregó empresa a la interface 672
...
'Global Const UltimaModificacion = "" 'Carmen Quintero - CAS-31268 - IBT - CUSTOM PARTE DE CAMBIO DE TURNO [Entrega 3]
                                     'Se agrego validacion en el modelo 402 Importación de Partes de Cambio de Turno (Custom)
...
'Global Const UltimaModificacion = "" 'Carmen Quintero - CAS-31268 - IBT - CUSTOM PARTE DE CAMBIO DE TURNO [Entrega 2]
                                     'Modificaciones varias al modelo 402 Importación de Partes de Cambio de Turno (Custom)
                                     
'Global Const Version = "6.15"
'Global Const FechaModificacion = "31/08/2015"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-32562 - RH Pro (Producto) - H&A - Modelos para Teléfonos
                                     'Modelo 1006 - Se agregó carga del código telefónico (el formato es dinámico)
...
'Global Const UltimaModificacion = "" ' LED - CAS-28350 - Salto Grande - Custom ADP - Organigrama Funcional
                                     'nuevo modelo 400 - Importación de dependencia de estructuras
...
'                     Se agregó el modelo 402 Importación de Partes de Cambio de Turno (Custom)
...
'                    Se agregó en el modelo 312 el control sobre el número de tarjeta

'Global Const Version = "6.07"
'Global Const FechaModificacion = "05/08/2015"
'Global Const UltimaModificacion = "" 'Sebastian Stremel - CAS-30758 - ACARA - SO - ABM de visitas medicas y nueva interfaz de importación
...
'Global Const UltimaModificacion = "" 'LED - CAS-28350 - Salto Grande - Custom ADP – Importación masiva de archivos
'                                 Nuevo modelo de interfaz 2005 - Importación masiva de archivos

'Global Const Version = "6.04"
'Global Const FechaModificacion = "02/07/2015"
'Global Const UltimaModificacion = "" 'Carmen Quintero - CAS-22072 - Raffo - Adecuaciones GDD - Migración historico People Review
                                     'Se agregó el modelo 401 Importación de Histórico de People Review (Custom)
'Global Const Version = "6.03"
'Global Const FechaModificacion = "29/06/2015"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-17053 - Nac Brasil – Nacionalización Brasil - Reporte ESOCIAL
                                     'Se agregó Tipo de Logradouro para modelo de BRASIL : Interfaz 668 y 922
...
'Global Const UltimaModificacion = "" ' Borrelli Facundo - CAS-31286 - COMPAÑIA DE ALIMENTOS - Bug en interfaz 245
...
'                                   Se agregó al modelo 2003 - Importación de Licencias con control de días habiles
'
'   Ademas
'                                  CAS-30739 - SYKES EL SALVADOR - LIQ - Bug interfase 354
'                                   Modelo 354 (se cambió validacion de fechas).
...
''                                      Se corrigió insert de la interface 2001,guardaba solo la hora desde
''                                      Se corrigió la interface 2002 , insertaba mal la hora en decimal
...
'                                   Se agregó al modelo 2002 - Interface de Horario Cumplido - el campo 'horestado' al insert
...
'                                   Se agregó el modelo 2002 - Interface de Horario Cumplido
...
'Global Const UltimaModificacion = "" ' Sebastian Stremel - CAS-30411 - Salto Grande -  Creación de Interfase importación de  Nick Names
...
'Global Const UltimaModificacion = "" ' LED - CAS-25180 - Unión Personal - Desarrollo de nueva interfaz para EyP [Entrega 4] - Se agrego nivel de estudio
...
'Global Const UltimaModificacion = "" 'Miriam Ruiz - CAS-16441 - H&A - PERU - Nacionalizacion Perú - Modificación interfaz 672
'                                     ' Se modific´0 la interfaz 672 se agregaron dos campos si el contrato tiene período a prueba
'                                     ' y fecha de fin de prueba, en caso de que la misma venga vacía se calculan 90 días a paratir de la fecha de alta del empleado
...
'Global Const UltimaModificacion = "" 'Miriam Ruiz - CAS-16441 - H&A - PERU - Nacionalizacion Perú - Modificación interfaz 672 [Entrega 3]
                                     ' Se agregó control sobre el tipo de estructura cuando venía N/A
...
'Global Const UltimaModificacion = "" 'Miriam Ruiz - CAS-28350 - Salto Grande - Custom ADP - Reporte de Familiares-Inteface
                                     ...
                                     'Legajo, nombre, apellido, fecha de nacimiento, país de nacimiento, nacionalidad, estado civil, Sexo, parentesco, Tipo Documento, Nro documento y A CARGO CTM
...
'Global Const UltimaModificacion = "" 'Fernandez, Matias - CAS-29429 - Salto Grande - QA- bug importación interfaz 387 - si el documento no
...
'Global Const UltimaModificacion = "" 'Miriam Ruiz - CAS-16441 - H&A - PERU - Nacionalizacion Perú - Modificación interfaz 672 [Entrega 3]
'                                     Se cambió a fecha de fin de período de prueba
'                                     a 89 días despues de la fecha de fin del contrato

'Global Const Version = "5.80"
'Global Const FechaModificacion = "11/02/2015"
'Global Const UltimaModificacion = "" 'LED - CAS-25180 - Unión Personal - Desarrollo de nueva interfaz para EyP [Entrega 3]
...
'Global Const UltimaModificacion = "" ' Miriam Ruiz - CAS-16441 - H&A - PERU - Nacionalizacion Perú - Modificación interfaz 672 -
'                                     Si el pais es perú cuando se da el alta del contrato calcula la fecha de fin de período de prueba
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-25641 - VSO - PRAXAIR BOLIVIA - Interface Empleados -
'                                     ' - Se controlan caracteres invalidos en nombre y apellido. Se agregó terape2 y ternom2 al insert de empleado.
...
'Global Const UltimaModificacion = "" 'LED - CAS-25180 - Unión Personal - Desarrollo de nueva interfaz para EyP
...
'                                   ' se agregó fecha de vigencia desde y hasta a la interfaz 317
...
'Global Const UltimaModificacion = "" 'FGZ - CAS-26028 - H&A - Mejora en indicadores individuales
                                     'se modificó la validacion de cantidad de campos del modelo 2000.
...
'Global Const FechaModificacion = "23/12/2014"
'Global Const UltimaModificacion = "" ' Gonzalez Nicolás - CAS-27929 - UTDT - Planilla Horaria - Nuevo modelo 2001 - Interfaz de Planilla Horaria
...
'Global Const UltimaModificacion = "" ' Dimatz Rafael - CAS-22751 - VILLA MARIA - Adecuacion Empleos y Postulantes - Modificación Interfaz 921
...
'Global Const FechaModificacion = "19/12/2014"
'Global Const UltimaModificacion = "" 'Ruiz Miriam - CAS-26028 - H&A - Mejora en indicadores individuales - Se agregó la interface 2000
...
'Global Const FechaModificacion = "05/12/2014"
'Global Const UltimaModificacion = "" 'Sebastian Stremel - modelo 275, se permite guardar hasta 500 caracteres en el campo tareas desempeñadas - CAS-28074 - IHSA - Planificador Empleos y Postulantes
                                     


'Global Const Version = "5.58"
'Global Const FechaModificacion = "04/12/2014"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás -CAS-16441 - H&A - PERU - Nacionalizacion Perú - Modificación de la interfaz de familiares y domicilios
...
'Global Const UltimaModificacion = "" ' EAM - sse Agregó un nuevo modelo para R4 de Licencia GIV
...
'Global Const UltimaModificacion = "" ' Gonzalez Nicolás - Modelo de Honduras interfaz 668 y 1006
...
'Global Const UltimaModificacion = "" ' CAS-16441 - H&A - PERU - PVS T-REGISTRO - Cambio Legal [Entrega 3]
                                     ' Modificacion en modelo 297, error en el año de la carrera.
...
'Global Const UltimaModificacion = "" ' Sebastian Stremel - Se creo el modelo 395 - Importacion de dias de turismo
                                     ' CAS-26789 - Santander Uruguay - Días de turismo - Licencia Paga - Licencia 25 años
...
'Global Const UltimaModificacion = "" 'Carmen Quintero - CAS-26942 - SYKES - ERROR EN CARGA DE INTERFAZ (CAS-15298)
       'Se modifica la consulta que verifica si existe superposición en el modelo 341
...
'Global Const UltimaModificacion = "" 'Fernandez, Matias - CAS-27132 - ACARA - bug en interfaz 230 pedido de vacaciones
       'Se rediseño la interfaz 230, se dejo la que estaba como actual como OLD...
...
'                   Se modificó modelo 246 se sacó la fecha de vigencia y se solucionó el problema con los decimales


'Global Const Version = "5.32"
'Global Const FechaModificacion = "29/08/2014"
'Global Const UltimaModificacion = "" 'Miriam Ruiz - CAS-17053 - Nac Brasil – Nacionalización Brasil - reporte Manad
'                   Se modificó modelo 668  y el 1006, se agregó municipio para Brasil
...
'                   Se creó modelo 293 (copia del 354 pero el periodo  se indica con MMYYYY en lugar de pliqnro)
'                   Modelo 233: se agregó mejora de validacion de observaciones y Fecha de certificado
...
'                   Modelo 640: Se agregó validacion : si los datos a migrarse tienen el tilde de 'Fecha de Alta reconocida',
'                   y también esta tildada la 'Fecha de Alta Reconocida'  de la Fase Activa.
'                   Solo debería quedar tildada la Fecha de Alta Reconocida de la Fase Histórica.
...
'                   Modelo 233: se agregó mejora de validacion de periodo de vacaciones

'Global Const Version = "5.25"
'Global Const FechaModificacion = "30/07/2014"   'FGZ
'Global Const UltimaModificacion = "" 'CAS-21778 - Sykes El Salvador - Interface modelo 233 y 335
''                   Modelo 335: se corrigio el script de la insert. faltaba las comillas simples en las horas
''                   Modelo 233: se agregó campo de fecha de certificado (Opcional)
...
'                                     ' Se modificó la consulta que valida si el nro de via existe en la tabla via.
'                                     ' Se modificó para que se guarde la descripcion de la empresa en el campo empresa de la tabla empant
...
'                                     ' modelo 211: Se agregó función listaConceptosPermitidos()
'                                     ' modelo 354: Se agregó función listaConceptosPermitidos()
...
'Global Const UltimaModificacion = "" ' CAS-26326 - SYKES - ERROR EN INTERFAZ 341
                                     ' Se corrigió el sql que verificaba la superposición de novedades


'Global Const Version = "5.21"
'Global Const FechaModificacion = "25/06/2014"
'Global Const UltimaModificacion = "" ' CGonzalez Nicolás - CAS-25705 - Heidt - Nacionalizacion Mexico - Domicilio
...
'Global Const UltimaModificacion = "" ' Gonzalez Nicolás - CAS-23705 - SYKES - BUG EN CARGA DE INTERFAZ 341
'                                     ' 341: Se cierra vigencia anterior cuando se inserta un registro con la vigencia abierta.


'Global Const Version = "5.18"
'Global Const FechaModificacion = "19/06/2014"
'Global Const UltimaModificacion = "" ' Gonzalez Nicolás - CAS-25705 - Heidt - Nacionalizacion Mexico - Domicilio
                                     ' 1006 - Interfaz Organización Territorial Multipaís.
                                     ' 668 - Se crearon nuevas funciones para validación de org. territorial.


'Global Const Version = "5.17"
'Global Const FechaModificacion = "12/06/2014"
'Global Const UltimaModificacion = "" ' Gonzalez Nicolás - CAS-23705 - SYKES - BUG EN CARGA DE INTERFAZ 341
                                     ' 341: Se cierra la vigencia a un día anterior de la fecha desde.
...
'Global Const FechaModificacion = "26/05/2014"
'Global Const UltimaModificacion = "" ' Gonzalez Nicolás - CAS-25641 - VSO - PRAXAIR BOLIVIA - Interface Empleados
                                     ' Se creó modelo 616 Importación de Empleados Bolivia. (Copia 605)
...
'                                    'Se modificó el modelo 668 (Importación de Domicilios Multi-País) - Se corrigió la insercion de Telefonos.
...
''                                    'Se modificó el modelo 921 (Importacion de Postulantes de Perú)
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-24464 - VILLA MARIA - Importación de Domicilios Multi-País - Se agregaron tipos de teléfonos al modelo 668
...
'                                      Gonzalez Nicolás - CAS-24204 - NACIONALIZACION BOLIVIA - Modelo de domicilio Bolivia.
'                                      Modelo 668 - Se agregó Código Postal Para Bolivia.

'Global Const Version = "5.05"
'Global Const FechaModificacion = "06/03/2014"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-24204 - NACIONALIZACION BOLIVIA - Modelo de domicilio Bolivia.
                                     ' Se agregó modelo para Bolivia
...
'Global Const UltimaModificacion = "" 'Carmen Quintero - CAS-17135 - HEIDT - Mejoras en origen de curso de GDD - Se modificó el modelo 290 por agregarse validación en la última
...
'07/01/2014 - Gonzalez Nicolás - Modelos 265 y 387  - Se corrige error al validar si ya existe un documento para otro empleado.
...
'                                      '02/01/2014 - Gonzalez Nicolás - Modelo 265 - Se agrego variable insertaFecha para corregir error al insertar/update la fecha cuando venia con N/A
...
'Global Const UltimaModificacion = "" 'LED - CAS-22808 - SGS - Distribución Contable
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-21260 - Sykes El Salvador - Modelo de Domicilio El Salvador.
'                                     Modelo 668 - Modificación en domicilio SL

'Global Const Version = "4.84"
'Global Const FechaModificacion = "03/10/2013"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-20391 - H&A - Multipais - Modelo 668 - Importación Domicilios Multi-Pais.
'                                     Modelo 668 - Se agregó domicilios de CR y SL
...
''                                      modelo 246 - Se modificó para que la Fecha Vigencia se actualice en la tabla cabgrilla

'Global Const Version = "4.78"
'Global Const FechaModificacion = "20/08/2013"
'Global Const UltimaModificacion = "" ' Gonzalez Nicolás - CAS-19944 - SYKES CR - Error en licencias pagas
...
''                                      modelo 246 - Se agregó el campo de Fecha Vigencia

'Global Const Version = "4.76"
'Global Const FechaModificacion = "10/07/2013"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-19126 -  RAPSODIA - Interfaz Domicilios multipais'
'                                      modelo 668 - Se comento EMAIL en modelo de Venezuela

'Global Const Version = "4.75"
'Global Const FechaModificacion = "05/07/2013"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-19167 - RAPSODIA - Mejora interfaz familiares -
...
'Global Const UltimaModificacion = "" '24/06/2013 - Mauricio Zwenger - CAS-15590 - Se modificó la sección de lectura de parametros
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-17878 - SYKES CR - Reporte de pendiente de firmas.
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-18330 - H&A - ECUADOR - Modelo de Domicilio
'                                     'Modelo 668: Se agregó ECUADOR al modelo de domicilios.
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-19126 -  RAPSODIA - Interfaz Domicilios multipais
                                     ...
                                     ' Chile, Colombia, Brasil , Uruguay, Venezuela, Méjico y Paraguay
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-18147 - Sykes - Replicar Interfaz 341
...
'Global Const UltimaModificacion = "" 'LED - CAS-13764 - H&A - Imputacion Contable
                                    'Se agrego la validacion si existe una hora para el mismo proyecto, día, tercero y fecha y acualiza o inserta.
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-17567 - GRUPO BAPRO - ERROR EN INTERFACES DE NOVEDADES
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-16578 - Sykes - Error de Licencias CR
'                                    'Modelo 344: Se comento validación para licencias con fecha posterior. (Sykes ya no lo utiliza)
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-16578 - Sykes - Error de Licencias CR
'                                     Modelo 344 - Se calcula la cantidad de dias de la lic. 18 Según límite por evento.
...
'Global Const UltimaModificacion = "" 'Manterola Maria Magdalena - CAS-16441 - H&A - PERU - 605 multinacional reducida
                                     'Modelo 664 - Similar al Modelo 605 pero reducido. Se modificó para que en Nombre y Apellido se pueda ingresar sin @.
...
'Global Const UltimaModificacion = "" 'Carmen Quintero - CAS-16833 - Vision Outsourcers - Chacomer Py - Interfaz Comisiones Produccion
                                     'Modelo 667 - Importación de Novedades Globales con Vigencia Diaria. Estandar
...
'Global Const UltimaModificacion = "" 'Margiotta, Emanuel CAS-15533 - PKF - Interfaz de Importación de Novedades Micros Fidelio
...
'Global Const UltimaModificacion = "" 'CAS-15533 - PKF - Interfaz de Importación de Novedades Micros Fidelio
...
'Global Const UltimaModificacion = "" 'Carmen Quintero - CAS-16536 - TATA - ADP - Interfaz de Familiares Nacionalización
...
'Global Const FechaModificacion = "31/07/2012"
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-16555 - Sykes - Error Interfaces -
''                                     Modelo 344 - Insertaba mal una licencia cuando era menor de 3 días.
...
'Global Const UltimaModificacion = "" 'Gonzalez Nicolás - CAS-16040 - Sykes - Interfaz de licencias
...
''                Modelo 603: Se modificó para que, si el documento no es un empleado y pertenece a un:
...
'               Modelo 604: Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.
'               Modelo 605: Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.
'               Modelo 606: Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.
'               Modelo 607: Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.
'               Modelo 608: Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.
'               Modelo 609: Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.
'               Modelo 611: Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.
'               Modelo 612: Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.
'               Modelo 613: Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.
...
'Global Const UltimaModificacion = "" 'Al incorporar el postulante como empleado, se habilitará al mismo para el acceder al ESS para acceder con un perfil y password determinados por defecto  por la empresa.


'Global Const Version = "4.21" ' Gonzalez Nicolás
'Global Const FechaModificacion = "24/05/2012" 'Modelo 344 - CAS-15972 - Sykes - Error Tope Días de Licencias
'Global Const UltimaModificacion = "" 'Se toman en cuenta las licencias 46 y 48 para partición de lic. 8

'Global Const Version = "4.20" ' Zamarbide Juan - Modelo 605 - CAS-15767 - SOS - QA - BUG INTERFACE 605
'Global Const FechaModificacion = "15/05/2012" 'Modelo 605 - Se modificó la función AsignarEstructura_SitRev2 por que no contemplaba el caso que estén dando de alta un empleado
'Global Const UltimaModificacion = "" 'Además se modificó la llamada por que sólo realizaba los cambios a los empleados activos.

'Global Const Version = "4.19" ' Zamarbide Juan - Modelo 351 - CAS-15533 - PKF - Interfaz de Importación de Novedades Micros Fidelio
'Global Const FechaModificacion = "04/05/2012" 'Modelo 351 - Se concatenó un 80 delante del Nº de Legajo, para que coincida con el de RHPro en PKF
...
'Global Const FechaModificacion = "18/04/2012" 'Modelo 211 y 245 - Se Se cambió el tipo de dato de la variable Monto de Single a Double
'Global Const UltimaModificacion = ""
...
'Global Const Version = "4.13" ' Zamarbide Juan - CAS-15533 - PKF - Interfaz de Importación de Novedades Micros Fidelio
...
'Global Const UltimaModificacion = "" ' las Novedades de Hs seg{un configuraci{on de las Columnas del Confrep N°368 - Al mismo se configuran 6 Columnas
                                     ' con nro de columna, la descripción, código de tipo de parámetro y código de concepto asociado a la novedad.
...
'Global Const Version = "4.11"  'Gonzalez Nicolás - CAS-15529 - Sykes - Error importación novedades
...
'Global Const FechaModificacion = "03/04/2012" ' Corrección de error - faltaban las comas de separación de campos en el UPDATE de tercero
...
'Global Const Version = "4.07"  'Gonzalez Nicolás
...
''                                                        : Se agregó validación por confrep de las licencias permitidas para importación
'Global Const UltimaModificacion = ""

'Global Const Version = "4.06"  'Gonzalez Nicolás
...
'                                              Nuevos módulos: MdlMidioma y MdlInterfacesPortugal
'                                              Modelo 612: Nueva importación de empleados - Portugal
'                                              Modelo 912: Nueva importación de familiares - Portugal
'                                              Modelo 344: Se corrigió error en UPDATE (Faltaba una coma)- Sykes
'                                              Modelo 336: Se agregó BK de firmas y se valida el detalle del parte antes de insertar - Sykes
'                                              Se modificó el orden de las versiones (La última esta primero)
...
'Global Const Version = "4.05"  'Gonzalez Nicolás
...
'Global Const FechaModificacion = "19/01/2012" 'Modelo 343: 'Se le agregó depuracioon por vigencia
'Global Const UltimaModificacion = " "

'Global Const Version = "4.03"  'Manterola Maria Magdalena
'Global Const FechaModificacion = "12/01/2012" 'Modelo 603: 'Se le agregó un cartel al log con el nombre y tipo de la estructura que se está intentando crear.
'Global Const UltimaModificacion = " "

'Global Const Version = "4.02"  'FGZ
'Global Const FechaModificacion = "10/01/2012" 'Modelo 343: 'Se le agregó depuracioon por vigencia
'Global Const UltimaModificacion = " "


'Global Const Version = "4.01"  'Manterola Maria Magdalena
'Global Const FechaModificacion = "22/12/2011" 'Modelo 349: Se eliminó la validación fija por longitud. Ahora se compara con el maximo obtenido de la tabla gti_tiptar

'para el tipo de tarjeta importado.
'Global Const UltimaModificacion = " "

'Global Const Version = "4.00"  'Manterola Maria Magdalena
'Global Const FechaModificacion = "13/12/2011" 'Modelo 333: Se modificó la interfaz 333 para que actualice correctamente el progreso y que muestre un error en caso que

'el idtarjeta ingresado no sea numerico
'Global Const UltimaModificacion = " "

'Global Const Version = "3.99"  'Manterola Maria Magdalena
'Global Const FechaModificacion = "13/12/2011" 'Modelo 344: Se agregó a la interfaz de licencias para Sykes un campo mas: dias habiles
'Global Const UltimaModificacion = " "

'Global Const Version = "3.98"  'Manterola Maria Magdalena
'Global Const FechaModificacion = "12/12/2011" 'Modelo 603: Se agregó validación por confrep (reporte 363) de habilitación o no a modificar o crear estructuras o tipos

'de estructuras para Sykes.
'Global Const UltimaModificacion = " "

'Global Const Version = "3.97"  'Manterola Maria Magdalena
'Global Const FechaModificacion = "01/12/2011" 'Modelo 349: Se agregó el nuevo modelo idem al 312 para Sykes pero sin la validación de tipos de estructuras
...
'Global Const FechaModificacion = "23/11/2011" 'Modelo 605: Se agregó la función ValidaEstructura2 y adicionó una entrada más a la función CreaComplemento por lo que
...
'Global Const Version = "3.94"  'Gonzalez Nicolás
'Global Const FechaModificacion = "16/11/2011" 'Modelo 312: Se comento validación de legajo.
                                              'Modelo 341: se agregó columna usuario y se modifico la forma en que valida el usuario FF.
'Global Const UltimaModificacion = " "
...
'Global Const FechaModificacion = "03/11/2011" 'Modelo 344: Se corrigió error cuando se insertaba en gti_justificaciíon para la lic. tipo 8
'Global Const UltimaModificacion = " "

'Global Const Version = "3.90"  'Manterola Maria Magdalena
'Global Const FechaModificacion = "25/10/2011" 'Modelo 286: Se creo dicho modelo, el cual tiene el formato de la interfaz 275 estándar,
'                                              'mas 10 columnas para importar hasta 5 valores para tipos e items de información general.
'Global Const UltimaModificacion = " "

'Global Const Version = "3.89"  'Zamarbide Juan Alberto
'Global Const FechaModificacion = "24/10/2011" 'Modelo 613: Se creo dicho modelo para Migración de Chile, versión custom INDAP, el cual es una copia del 607 a la fecha
'Global Const UltimaModificacion = " "         'Modelo 607: Se volvieron atrás los cambios de los campos Bienios(custom INDAP), dado que no funcionaban para Deloite y

'demás empresas. Ahora la 607 con bienios es la 613

'Global Const Version = "3.88  'Gonzalez Nicolás"
...
'Global Const Version = "3.87  'Gonzalez Nicolás"
'Global Const FechaModificacion = "17/10/2011" 'Modelo 344: Se agregó partición de licencia tipo 8 - Sykes
                                              'Modelo 335: Se corrigió validación de fechas y sql que validaba superposición de novedades
                                              'Modelo 603: Se amplió el campo Calle a 250
'Global Const UltimaModificacion = " "
...
'                                                   a ambos modelos se le actualizó el campo elmaxhoras para que se vean las cantidad masima de hs a justificar cuando

'la licencia es parcial variable

'Global Const Version = "3.83"                 'FGZ
'Global Const FechaModificacion = "18/08/2011" ' modelo 605: Se agregó función AsignarEstructura_SitRev2()
'Global Const UltimaModificacion = " "


'Global Const Version = "3.82"                 'Sebastian Stremel
'Global Const FechaModificacion = "17/08/2011" 'Se agregó el tipo de telefono al modelo 602 y modelo 600 cuando se agrega un nuevo familiar
'Global Const UltimaModificacion = " "

'Global Const Version = "3.81"                 'Zamarbide Juan - CAS-12814 - Teletech - Interface 233 - Rechazo
'Global Const FechaModificacion = "11/08/2011" 'Se agregó al comienzo de la validación del período de vacaciones, la verificación del valor de la variable PeriodoVac
...
'realizará
                                              'la validación correspondiente y la posterior inserción de datos.
...
'Global Const UltimaModificacion = " " ' Manterola Maria Magdalena
                                      ' modelo 630: Se Agregó la verificación para CrearComplemento (VerSiCrearComplemento)
...
'Global Const UltimaModificacion = " " ' Manterola Maria Magdalena
                                      ' modelo 605: Se Modificó la llamada a CrearComplemento con tipoEstr = 23 en vez que con 25


'Global Const Version = "3.75"
'Global Const FechaModificacion = "28-06-2011"
'Global Const UltimaModificacion = " " ' FGZ
                                      ' modelo 334: Se redefinió variable tienepermiso
                                      ' modelo 337: Se redefinió variable tienepermiso
                                      ' modelo 338: Se redefinió variable tienepermiso
                                      ' modelo 339: Se redefinió variable tienepermiso
                                      ' modelo 341: Se redefinió variable tienepermiso
                                      
                                      ' modelo 344: Se cambió columna Período de vacaciones x usuario firmante

'Global Const Version = "3.74"
'Global Const FechaModificacion = "22-06-2011"
'Global Const UltimaModificacion = " " ' FGZ
'                                      ' modelo 285: se le agregó un parametro opcional para reflejar si esta saldado o no
...
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
'                                      ' modelo 233: Se cambió validación del período de vacaciones

'Global Const Version = "3.71"
'Global Const FechaModificacion = "14-06-2011"
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
                                      ' modelo 344: Se corrigió error (Relizaba una consulta y validaba con otro nombre de objeto)

'Global Const Version = "3.70"
'Global Const FechaModificacion = "10-06-2011"
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
                                      ' modelo 334: Se agregó función listaConceptosPermitidos()
                                      ' modelo 337: Se agregó función listaConceptosPermitidos()
                                      ' modelo 338: Se agregó función listaConceptosPermitidos()
                                      ' modelo 339: Se agregó función listaConceptosPermitidos()
                                      ' modelo 341: Se agregó función listaConceptosPermitidos()
                                      ' modelo 344: Se cambió columna Período de vacaciones x usuario firmante

'Global Const Version = "3.69"
'Global Const FechaModificacion = "03-06-2011"
'Global Const UltimaModificacion = " " ' FGZ
                                      ' modelo 334: Importacion de cafeteria - Se cambió la validacion del nro de legajo

'Global Const Version = "3.68"
'Global Const FechaModificacion = "02-06-2011"
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
'                                      ' modelo 344: Se agregó nuevo modelo = 233 + CIRCUITO DE FIRMAS
'                                      ' Se creo nueva función firmas_lista()
'                                      ' Se modifico función firmas_Nov()

'Global Const Version = "3.67"
'Global Const FechaModificacion = "01-06-2011"
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
                                      ' modelo 605: Se agregó función AsignarEstructura_SitRev()
...
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
                                       ' modelo 334: Se agregó variable firmas
                                       ' Modelo 337: Se agregó variable firmas
                                       ' modelo 338: Se agregó variable firmas
                                       ' modelo 339: Se agregó variable firmas
                                       ' modelo 341: Se agregó variable firmas
                                       ' modelo 233: Se agregó columna Periodo de Vacaciones + inserta complemento

'Global Const Version = "3.64"
'Global Const FechaModificacion = "17-05-2011"
'Global Const UltimaModificacion = " " ' FGZ
                                      ' modelo 640: Se modificó el modelo para que inserte registros historicos aun cuando ya existan fases posteriores.

'Global Const Version = "3.63"
'Global Const FechaModificacion = "12-05-2011"
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
'                                      ' modelo 334: Se corrigió error de formato en var firmas_ok
'                                      ' Modelo 337: Se corrigió n° de modelo | Se corrigió error de formato en var firmas_ok
'                                      ' modelo 338: Se corrigió error de formato en var firmas_ok
'                                      ' modelo 339: Se corrigió error de formato en var firmas_ok
'                                      ' modelo 341: Se corrigió error de formato en var firmas_ok


'Global Const Version = "3.62"
'Global Const FechaModificacion = "04-05-2011"
'Global Const UltimaModificacion = " " ' FGZ  -
'                            Se modificó insert en la tabla telefonos (faltaba el tipotel y luego no los mostraba)
'                            Modelos afectados
...
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
'                                      ' Modelo 28:Se modificó insert en la tabla emp_fr_comp
...
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
                                      ' modelo 339: Nuevo Modelo - Interface Banco Popular (Novedades de Liq) - Sykes CR
                                                   'Se creó funcion Firmas_novliq() - Sykes - CR
                                      ' modelo 338: Se agregó funcion Firmas_novliq()
                                      ' modelo 337: Se agregó funcion Firmas_novliq()
                                      ' modelo 334: Se agregó funcion Firmas_novliq()
                                      ' modelo 341: Nuevo Modelo - Replica Linea_modelo_211 Adecuado para Sykes CR
                                                    'Se creó función listaConceptosPermitidos() - Sykes - CR
                                      
                                      'Se eliminó código en el MAIN asociado al modelo 333
...
'Global Const UltimaModificacion = " " ' FGZ
'                                      ' - el modelo 333 ya no se usa, se comentó todo el procedimiento

'Global Const Version = "3.56"
'Global Const FechaModificacion = "06-04-2011"
'Global Const UltimaModificacion = " " ' Manterola Maria Magdalena
'                                      ' - Modificación del número de Modelo 329 por el número 337
'                                      ' - Modificación del número de Modelo 331 por el número 338
...
'Global Const UltimaModificacion = " " ' Martínez Nicolás
...
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
                                      '- Mod. Modelo 335 - Se agregó nuevos N° de errores InsertaError()
                                      '- Mod. Modelo 336 - Se agregó nuevos N° de errores InsertaError()
...
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
                                      '- Mod. modelo 334 - Se modificó el número del reporte por el número 310
                                      '- Mod. Modelo 335 - Se agregó validación para Fin de firma
                                      '- Mod. Modelo 336 - Se agregó validación para Fin de firma

'Global Const Version = "3.50"
'Global Const FechaModificacion = "04-03-2011"
'Global Const UltimaModificacion = " " ' Manterola María Magdalena
                                      '- Mod. modelo 331 - Se modificó el número del reporte por el número 313

'Global Const Version = "3.49"
'Global Const FechaModificacion = "02-03-2011"
'Global Const UltimaModificacion = " " ' FGZ - modelo 605 - Se sacó la fecha de baja en el manejo de historico de estructuras.
...
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás
                                      ' - Nuevo modelo 335 - Interface de Importación de Novedades Horarias - Sykes - Costa Rica.
                                      ' - Nuevo modelo 336 - Interface de Importación de Partes Diarios - Sykes - Costa Rica.

'Global Const Version = "3.46"
'Global Const FechaModificacion = "15-02-2011"
'Global Const UltimaModificacion = " " ' Margiotta Emanuel - Nuevo modelo 333 - Interface de Importación de Novedades - Sykes - Costa Rica.

'Global Const Version = "3.44"
'Global Const FechaModificacion = "11-02-2011"
'Global Const UltimaModificacion = " " ' Gonzalez Nicolás - Nuevo modelo 334 - Interface de Importación de Cafetería - Sykes Costa rica.
...
'Global Const UltimaModificacion = " " ' Manterola Maria Magdalena - Nuevo modelo 331 - Interface de Importacion Archivos de Afiliación de AsoSykes
...
'Global Const UltimaModificacion = " " ' Leti A. - Modelo 602: se comento MsgBox("") en chequeo de Documento (colgaba el proceso)
                                      ...
                                      '         - Migración Inicial: se inicializa la variable HuboError a False y nroclumna a 0 en Insertar_linea_...
...
'Global Const UltimaModificacion = " " ' Leti A. - se eliminan caracteres invalidos de campos de texto.
                                      ...
                                      ' FGZ - Modelo 253 - Embargos. Se corrigió la asignacion de cantidad de cuotas cuando es por porcentaje
...
'Global Const UltimaModificacion = " " ' Leticia A. - Modelo 233 - cambiar la Situación de Revista asociada a la licencia
...
'Global Const UltimaModificacion = " 08/07/2010 - Cesar Stankunas - Creación del Modelo 325 Interface de Anticipos"
''                                      Creación del Modelo 325 Interface de Anticipos
...
''                                           Se le agregó cierta logica para que actualice cuando puede, inserte cuando puede e informe del error cuando no.
...
'Global Const UltimaModificacion = " " 'FGZ
''                                      sub LeeArchivo()
''                                      Se agregó un control cuando el archivo a levantar está vacion

'Global Const Version = "3.25"
'Global Const FechaModificacion = "06/09/2010"
'Global Const UltimaModificacion = " " 'Margiotta Emanuel
'''                                      Modelo 230 Pedido de Vacaciones
'''                                      Se cambio el número de alcance por estructura de los periodos de vacaciones a 21
...
''                                            604 Importación Empleados Walmart
''                                            605 Importación de Empleados
''                                            606 Importación de Empleados Uruguay
''                                            607 Importación de Empleados Chile
''                                            609 Importación de Empleados Radiotronica
''                                            630 Importación Histórico de Estructuras
''                                            261 Importación Empresas
''                                            317 Importación de la Distribución Contable
''                                            300 Importación de Empleados Teleperformance
...
''                                      Se cambio el campo opcional de año de DDJJ por los campos desde y hasta fecha de DDJJ.

'Global Const Version = "3.12"
'Global Const FechaModificacion = "19/05/2010"
'Global Const UltimaModificacion = " " 'Cesar Stankunas - Se modificó el Modelo 245 - Se cambió la lógica para guardar las novedades de ajustes (se pisa, se deja como
...
'Global Const UltimaModificacion = " " 'FGZ - Se modificó el modelo 217 - Interface de Vales
'                                       Se agregó el periodo de descuento al modelo
...
'Global Const FechaModificacion = "11/12/2009"
'Global Const UltimaModificacion = " " 'FGZ - Se agregó un nuevo Modelo 285 - Interface de Francos Compensatorios

'Global Const Version = "2.97"
'Global Const FechaModificacion = "11/12/2009"
'Global Const UltimaModificacion = " " 'FGZ - Se modificó el modelo 217 - Interface de Vales
'                                      '    - Se modificó el modelo 318 - Interface Valor Plan Obra Social


'Global Const Version = "2.96"
'Global Const FechaModificacion = "11/12/2009"
'Global Const UltimaModificacion = " " 'Stankunas Cesar - Se creó el modelo 318 - Interface Valor Plan Obra Social - PRICE

'Global Const Version = "2.95"
'Global Const FechaModificacion = "07/12/2009"
'Global Const UltimaModificacion = " " 'Stankunas Cesar - Se creó el modelo 317 - Interface Distribución Contable - PRICE

'Global Const Version = "2.94"
'Global Const FechaModificacion = "04/12/2009"
'Global Const UltimaModificacion = " " 'Stankunas Cesar - Se modificó la Interface de Prestamos, modelo 229 - Se cambio el tipo de dato de "numero de comprobante" (Nro_Comprobante) a string para que acepte caracteres alfanumericos.
...
'Global Const UltimaModificacion = " " 'Cesar Stankunas - Se creó el modelo 248 - Carga de Recibos - Custom Farmacity


'Global Const Version = "2.89"
'Global Const FechaModificacion = "08/10/2009"
'Global Const UltimaModificacion = " " 'FGZ  - Correccion en Modelo 635 Importación de Titulos

'Global Const Version = "2.88"
'Global Const FechaModificacion = "09/09/2009"
'Global Const UltimaModificacion = " " 'FGZ  - Correccion en Modelo 659 Importación de asistencias de Capacitación
...
'Global Const UltimaModificacion = " " 'FGZ  - Se creó el modelo 315 - Historico de Ranking - Custom IAMSA

'Global Const Version = "2.85"
'Global Const FechaModificacion = "12/08/2009"
'Global Const UltimaModificacion = " " 'FGZ  - Se modificó el modelo 245
...
'Global Const UltimaModificacion = " " 'Diego Nuñez - Se modificó el modelo 609 para la migración de empleados de RADIOTRONICA. A los empleados ya
''                                                    existentes se le cierran las estructuras anteriores y se crean nuevas, salvo en el caso que se
''                                                    seleccione la opción de sobreescribir empleados, en cuyo caso se sobreescribe el histórico de
''                                                    estructuras.

'Global Const Version = "2.81"
'Global Const FechaModificacion = "22/05/2009"
'Global Const UltimaModificacion = " " 'Diego Nuñez - Se cambiaron en todos los meodelos que utilizaban las variables localidad y zona, el tamaño
'                                                    de las mismas, extendiendolas a 60 caracteres.

'Global Const Version = "2.80"
'Global Const FechaModificacion = "14/04/2009"
'Global Const UltimaModificacion = " " 'Diego Nuñez - Se agregó un nuevo modelo (281) que realiza las altas masivas de remuneraciones según
'                                                    las especificaciones recibidas de LA CAJA

'Global Const Version = "2.79"
'Global Const FechaModificacion = "26/03/2009"
'Global Const UltimaModificacion = " " 'Diego Nuñez - Se modificó modelo 211 que realiza las migraciones de novedades, para que sea capaz
'                                                    de manejar tipos de motivos y motivos. Además se se agregaron 5 nuevos formatos al archivo
'                                                    de entrada.
...
'Global Const UltimaModificacion = " " 'Diego Nuñez - Se agregó un nuevo modelo (609) que realiza las migraciones de empleados según
'                                                    las especificaciones recibidas de RADIOTRONICA

'Global Const Version = "2.76"
'Global Const FechaModificacion = "06/03/2009"
'Global Const UltimaModificacion = " " 'Diego Nuñez - Se agregó una función para que al validar el cuil en una importación
'                                                    de empleados, se verifique que el nro de documento esté incluido en
...
'Global Const UltimaModificacion = " " 'Lisandro Moro - Se modificó el modelo 245
...
'Global Const UltimaModificacion = " " 'FGZ - Se modificó el modelo 615 - LineaModelo_615 - migracion de DDJJ
''   No se estaba actualizando el campo prorratea
''    El Formato anterior era:
''    Legajo;Año;Fecha Desde;Fecha Hasta;Número de Item;Monto;Cuit;Razon Social;
''
''    Ahora es:
''        Legajo;Año;Fecha Desde;Fecha Hasta;Número de Item;Monto;Cuit;Razon Social;Prorratea

'Global Const Version = "2.70"
'Global Const FechaModificacion = "20/10/2008"
'Global Const UltimaModificacion = " " 'Diego Nuñez - Se modificó el modelo 250 - Alta Plástica
''Se modificó el código fuente de la interfase general del modelo 250 para que fuese capaz de manejar
''valores numéricos con configuración española, en un sistema con configuración regional Inglesa.
...
'                                       Se agregó campo "fecha de inicio del Vinculo"
...
'Global Const UltimaModificacion = " " 'Gustavo Ring - Se modifico el módelo 312.- Tarjetas. Ahora se inicializa "devuelta" en 0


'Global Const Version = "2.63"
'Global Const FechaModificacion = "28/02/2008"
'Global Const UltimaModificacion = " " 'Gustavo Ring - Se creo el módelo 662 interfaz de ctas de mails de empleados
...
'Global Const UltimaModificacion = " " 'Gustavo Ring - Se agrego el modelo 662 - Importación de Familiares - Standard
...
''                                   Ademas Le agregué 2 campos mas al formato de Porcentaje (acumulador y porcentaje)
''                           Formato
...
'Global Const UltimaModificacion = " " 'FGZ - Modelo 211 (Interfase de Novedades). Se sacó del estandar lo que se agregó en la version 2.49
''                                       Ese modelo 211 lo guardé como 211_Custom para recuperarlo y crearlo con un nuevo nro de modelo
''                                       Lo creé como modelo CUSTOM 313
...
'Global Const UltimaModificacion = " " 'Gustavo Ring - Se creo el modelo 661: Importación de Imágenes del Empleado - Estandar

'Global Const Version = "2.53"
'Global Const FechaModificacion = "17/08/2007"
'Global Const UltimaModificacion = " " 'FGZ - Se creo el modelo 660: Importación de Cuestionarios de Capacitacion - Estandar

'Global Const Version = "2.52"
'Global Const FechaModificacion = "26/07/2007"
'Global Const UltimaModificacion = " " 'Gustavo Ring - Migración Cap 657 - Se relaciono participantes con calendarios, se actualiza la cantidad de participantes y se agregaron Logs.
                         '             - Migración Cap 655,656,657,658,659 se puso como opcional el último separador. Tambien se inicializa fecha de
...
'Global Const UltimaModificacion = " " 'Gustavo Ring - Migración Cap modelos 655,656,657,658,659

'Global Const Version = "2.47"
'Global Const FechaModificacion = "30/04/2007"
'Global Const UltimaModificacion = " " 'Maximiliano Breglia - Se modificó el modelo 635 de Titulo que no andaba pq estaba mal el sql
...
' Autor      : FGZ
' Fecha      : 29/07/2004
' Ultima Mod.: 27/01/2012 - Gonzalez Nicolás
' Descripcion: Habilita Traducciones si MI este activo. Se agregó la funcion EscribeLogMI() en las etiquetas.
' ---------------------------------------------------------------------------------------------
...
' Autor      : ?
' Fecha      : ?
' Modificado : 13/02/2012 - Gonzalez Nicolás - Se agregó Multilenguaje
' Modificado : 17/06/2014 - Gonzalez Nicolás - Se Formatea incporc a 14 decimales.
...
Dim Ciclos As Long
   ...
   'Abro el archivo
    ...
    If rs_modelo.EOF Then
        Flog.writeline Espacios(Tabulador * 0) & EscribeLogMI("No se encontró el modelo") & ": " & NroModelo
        Exit Sub
    End If
...
'              el parametro ConjCH indica que conjunto de carateres validos se usará
...
' Autor      : Leticia A.
' Fecha      : 24-11-2010
' Modificado : 20/01/2012 - Gonzalez Nicolás - Se agregaron carácteres válidos faltantes en cadalfabeto2.
'            : 13/02/2012 - Gonzalez Nicolás - Se agregó Multilenguaje
'            : 16/10/2012 - FGZ - agregué  ñ y Ñ a los caracteres validos
...
' conjunto de carateres validos _________________________________________________
    ...
    'FGZ - 16/10/2012 - agregué  ñ y Ñ a los caracteres validos
    cadalfabeto = "abcdefghijklmnñopqrstuvwxyzABCDEFGHIJKLMNÑOPQRSTUVWXYZ"
    'cadalfabeto2 = "äáëéïíöóüúÄÁËÉÏÍÖÓÜÚñÑ"
    cadalfabeto2 = "äáëéïíöóüúâêîôûãõçÄÁËÉÏÍÖÓÜÚÂÊÎÔÛÃÕÇ"
...
If Not IsNull(parametros) Then
    If Len(parametros) >= 1 Then
        ...
        Case 251: 'Exportación Roche
        Case 252: 'Exportación Indura
        Case 253: 'Importación de Embargos
        Case 254: 'Exp. Excel Comp. Ac.
        Case 255: 'Exportación BPS
        Case 256: 'Importacion de Engagements
        Case 257: 'Interface TTI (reservado)
        Case 258: 'Exportación de SIJP (reservado)
        Case 259: 'Exportación de SICORE (reservado)
        Case 260: 'Exportación de Libro Ley (reservado)
        ...
        Case 313: 'Interfase de Novedades con seguridad
            ...
            pos2 = Len(parametros)
            PisaNovedad = CBool(Mid(parametros, pos1, pos2 - pos1 + 1))
        Case 317: 'Interface Distribución Contable - PRICE
            'pos1 = pos2 + 2
            'pos2 = Len(parametros)
        ...
        Case 346: 'Interface de Novedades Simulacion
            ...
            pos2 = Len(parametros)
            AccionNovedad = Mid(parametros, pos1, pos2 - pos1 + 1)
        Case 347: 'Interface de Nov Ajuste Simulación
        ...
        Case 661: ' Migración de Imágenes de Empleados
            ...
            pos2 = Len(parametros)
            Pisa = CBool(Mid(parametros, pos1, pos2 - pos1 + 1))
        Case 668: ' Migración de Domicilios de Perú, Chile, Colombia, Brasil , Uruguay, Venezuela, Ecuador, Méjico y Paraguay
            'Guardo el modelo de domicilio. modnro
            ModeloDom = CInt(Mid(parametros, pos2 + 2, Len(pos2)))
        Case 922: ' Migración de Domicilios Multipais (Tipo y N° de DOC)
            'Guardo el modelo de domicilio. modnro
            ModeloDom = CInt(Mid(parametros, pos2 + 2, Len(pos2)))
        Case 1006: 'Organización Territorial Multipaís
            'Guardo el modelo de domicilio. modnro
            ModeloDom = CInt(Mid(parametros, pos2 + 2, Len(pos2)))
...
Dim Folder
    ...
    If Not objRs.EOF Then
        ...
        Flog.writeline
        Flog.writeline Espacios(Tabulador * 1) & EscribeLogMI("Directorio de importación") & " :  " & directorio
     Else
        Flog.writeline Espacios(Tabulador * 1) & EscribeLogMI("No se encontró el modelo") & " " & NroModelo
        Exit Sub
    End If
...
'        Call LineaModelo_222
    ...
    Case Else
        ...
        If Not EncontroAlguno Then
            Flog.writeline Espacios(Tabulador * 1) & EscribeLogMI("No se encontró el archivo") & " " & nombrearchivo
        End If
    End Select
    'FGZ - 19/01/2012 ------------------------------------
...
'               Aplica solo para las novedades de liquidación
' Autor      : Gonzalez Nicolás
' Fecha      : 19/04/2011
' Ultima Mod.: 12/05/2011 - Gonzalez Nicolás: Se setearon las variables en 0, para cuando hay error
' Ultima Mod.: 02/06/2011 - Gonzalez Nicolás: Si no tiene complemento o no tiene el concepto en la lista elige un fin de firma
'
' ---------------------------------------------------------------------------------------------
    ...
    Select Case tipoorigen
                Case 1: 'Perfiles----------------------------------------
                    ...
                    If Not rs_firmas2.EOF And rs_firmas2!detorigen = 0 Then
                        ...
                        Else
                            Firmas_novliq = cysfirusuario & "," & cysfirautoriza & "," & cysfirdestino & "," & cysfirfin & "," & cysfiryaaut & "," & cysfirrecha
                            Texto = ": " & "No hay existe ningún tipo de perfil"
                            NroColumna = 3
                            Call Escribir_Log("floge", NroLinea, NroColumna, Texto, Tabs, strLinea)
...
'y determina el primer usuario de la lista como siguiente en el circuito
    ...
    'SI NO TIENE COMPLEMENTO ASOCIADO BUSCO LISTA DEL CIRCUITO
        ...
        Else
            ...
            Texto = ": " & "No Existe ninguna lista asociada al código del circtuito " & cystipnro
            NroColumna = 3
            Call Escribir_Log("floge", NroLinea, NroColumna, Texto, Tabs, strLinea)
            Call InsertaError(3, 119)
            HuboError = True
