...
Public Sub DIF_FECHAS_AMR(ByVal F1 As Date, ByVal F2 As Date, ByRef Dias As Long, ByRef Meses As Long, ByRef anios As Long)
'/*----------------------------------------------------------------------
'CALCULA LA DIFERENCIA ENTRE DOS FECHAS EN DIAS, MESES Y AÑOS. f2>f1
'-----------------------------------------------------------------------*/
...
'-----------------------------------------------------------
Public Function AnsAntig(ByRef Ingreso As Date, ByRef Egreso As Date) As Long
Dim DifDias As Long
Dim DivDias As Long
DifDias = DateDiff("y", Ingreso, Egreso)
DivDias = CInt(DifDias / 365)
If DivDias > 0 Then
  AnsAntig = DivDias
Else
  AnsAntig = 0
