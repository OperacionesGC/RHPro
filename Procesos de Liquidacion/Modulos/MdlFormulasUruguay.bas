...
For I = LI_WF_Tpa To LS_WF_Tpa
    ...
    Case c_mon_dir:
        v_mon_dir = Arr_WF_TPA(I).Valor
    Case c_mon_mes:
        v_mon_mes = Arr_WF_TPA(I).Valor
    Case c_Acunro_Mensual:
        v_Acunro_Mensual = Arr_WF_TPA(I).Valor
    Case c_acunro_directo:
        v_acunro_Directo = Arr_WF_TPA(I).Valor
    Case c_porcentaje:
...
StrSql = StrSql & " INNER JOIN cabliq ON proceso.pronro = cabliq.pronro AND proceso.pronro <> " & buliq_proceso!pronro
StrSql = StrSql & " WHERE proceso.pliqnro = " & buliq_proceso!PliqNro
...
Do While Not rs_ya_desc.EOF
    ...
    StrSql = StrSql & " WHERE acu_liq.cliqnro = " & rs_ya_desc!cliqnro
    'FGZ - 09/02/2007 ---------------
    StrSql = StrSql & " AND acu_liq.acunro = " & v_Acunro_Mensual
    ...
    If Not rs_Acu_Liq.EOF Then
        ...
        StrSql = StrSql & " WHERE detliq.cliqnro = " & rs_Acu_Liq!cliqnro
        'FGZ - 08/02/2007 ---------------
        ...
        'FGZ - 08/02/2007 ---------------
        'StrSql = StrSql & " WHERE acu_liq.cliqnro = " & buliq_cabliq!cliqnro
        StrSql = StrSql & " WHERE acu_liq.cliqnro = " & rs_Acu_Liq!cliqnro
        'FGZ - 08/02/2007 ---------------
        StrSql = StrSql & " AND acu_liq.acunro = " & v_acunro_Directo
...
v_valorresto = 0
    ...
    For I = LI_WF_Tpa To LS_WF_Tpa
        Select Case Arr_WF_TPA(I).tipoparam
        Case c_valorresto:
            v_valorresto = Arr_WF_TPA(I).Valor
        Case c_indice_dia_1:
            v_indice_dia(1) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_2:
            v_indice_dia(2) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_3:
            v_indice_dia(3) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_4:
            v_indice_dia(4) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_5:
            v_indice_dia(5) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_6:
            v_indice_dia(6) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_7:
            v_indice_dia(7) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_8:
            v_indice_dia(8) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_9:
            v_indice_dia(9) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_10:
            v_indice_dia(10) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_11:
            v_indice_dia(11) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_12:
            v_indice_dia(12) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_13:
            v_indice_dia(13) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_14:
            v_indice_dia(14) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_15:
            v_indice_dia(15) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_16:
            v_indice_dia(16) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_17:
            v_indice_dia(17) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_18:
            v_indice_dia(18) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_19:
            v_indice_dia(19) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_20:
            v_indice_dia(20) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_21:
            v_indice_dia(21) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_22:
            v_indice_dia(22) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_23:
            v_indice_dia(23) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_24:
            v_indice_dia(24) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_25:
            v_indice_dia(25) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_26:
            v_indice_dia(26) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_27:
            v_indice_dia(27) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_28:
            v_indice_dia(28) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_29:
            v_indice_dia(29) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_30:
            v_indice_dia(30) = Arr_WF_TPA(I).Valor
        Case c_indice_dia_31:
            v_indice_dia(31) = Arr_WF_TPA(I).Valor
        Case c_tipohora:
            v_tipohora = Arr_WF_TPA(I).Valor
        Case c_coeficiente:
            v_coeficiente = Arr_WF_TPA(I).Valor
        Case c_franja2:
            v_franja2 = Arr_WF_TPA(I).Valor
        Case c_valorfranja1:
            v_valorfranja1 = Arr_WF_TPA(I).Valor
        Case c_valorfranja2:
            v_valorfranja2 = Arr_WF_TPA(I).Valor
        Case Else
        End Select
    Next I
...
StrSql = "INSERT INTO traza_gan (pliqnro,pronro,concnro,fecha_pago,empresa,ternro,empleg) VALUES ("
...
If Not Anual Then
    ...
    'Detalle Renta
    'EAM (6.73) - Se modifico el query para que busque los mayores o iguales.
    ...
    StrSql = StrSql & " ORDER BY valdesde ASC"
    ...
    'EAM (6.73) - Se saco el while por un if porque solo calcula 1 porcentaje
...
'**************************************************************************
    ...
    StrSql = "UPDATE traza_gan SET "
    StrSql = StrSql & " nogan =" & Sum_Renta
    StrSql = StrSql & " ,deducciones =" & Sum_Deduccion
    StrSql = StrSql & " ,porcdeduc =" & Aux_Por_Renta
    StrSql = StrSql & " ,nomsr =" & v_Imp_Renta_Vac
    StrSql = StrSql & " ,msr =" & v_Imp_Renta_Sac
    StrSql = StrSql & " WHERE "
    StrSql = StrSql & " pliqnro =" & buliq_periodo!PliqNro
    StrSql = StrSql & " AND pronro =" & buliq_proceso!pronro
    StrSql = StrSql & " AND concnro =" & Buliq_Concepto(Concepto_Actual).ConcNro
...
Public Function for_irpf_simple_OLD(ByVal NroCab As Long, ByVal AFecha As Date, Monto As Double, Bien As Boolean) As Double
' ---------------------------------------------------------------------------------------------
' Descripcion: Calculo de retencion de ganancias para uruguay. Calculo simple.
' Autor      : FGZ
' Fecha      : 26/06/2007
