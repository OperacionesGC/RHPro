...
Public Function for_203() As Double
' ---------------------------------------------------------------------------------------------
...
Dim v_prod_minima_de_peras As Double
...
bultos = 51 'tipo de hora donde guarda los bultos
    ...
    For I = LI_WF_Tpa To LS_WF_Tpa
        ...
        Case c_prod_minima_de_peras:
            v_prod_minima_de_peras = Arr_WF_TPA(I).valor
            If CBool(USA_DEBUG) Then
...
Public Function for_204() As Double
' ---------------------------------------------------------------------------------------------
...
Public Function for_207() As Double
' ---------------------------------------------------------------------------------------------
' Descripcion: Formula para el calculo de produccion: VA-Peras-Resto
'               Reccorre la produccion dia por dia y compara con el indice con el promedio, aplica el
'               porcentual de dia trabajado y aplica un monto global
...
Dim v_indice_dia_1 As Double
Dim v_indice_dia_2 As Double
Dim v_indice_dia_3 As Double
Dim v_indice_dia_4 As Double
Dim v_indice_dia_5 As Double
Dim v_indice_dia_6 As Double
Dim v_indice_dia_7 As Double
Dim v_indice_dia_8 As Double
Dim v_indice_dia_9 As Double
Dim v_indice_dia_10 As Double
Dim v_indice_dia_11 As Double
Dim v_indice_dia_12 As Double
Dim v_indice_dia_13 As Double
Dim v_indice_dia_14 As Double
Dim v_indice_dia_15 As Double
Dim v_indice_dia_16 As Double
Dim v_indice_dia_17 As Double
Dim v_indice_dia_18 As Double
Dim v_indice_dia_19 As Double
Dim v_indice_dia_20 As Double
Dim v_indice_dia_21 As Double
Dim v_indice_dia_22 As Double
Dim v_indice_dia_23 As Double
Dim v_indice_dia_24 As Double
Dim v_indice_dia_25 As Double
Dim v_indice_dia_26 As Double
Dim v_indice_dia_27 As Double
Dim v_indice_dia_28 As Double
Dim v_indice_dia_29 As Double
Dim v_indice_dia_30 As Double
Dim v_indice_dia_31 As Double
Dim v_monto As Double
...
Dim v_Trabajados As Double
Dim c_Total_de_Bultos As Integer
Dim v_Total_de_Bultos As Double
...
c_Total_de_Bultos = 163
    ...
    For I = LI_WF_Tpa To LS_WF_Tpa
        Select Case Arr_WF_TPA(I).tipoparam
        Case c_Trabajados:
            v_Trabajados = Arr_WF_TPA(I).valor
            Encontro1 = True
        Case c_Total_de_Bultos:
            v_Total_de_Bultos = Arr_WF_TPA(I).valor
            Encontro2 = True
        Case Else
        End Select
    Next I
