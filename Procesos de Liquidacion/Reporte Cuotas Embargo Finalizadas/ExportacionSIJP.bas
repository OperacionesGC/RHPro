    ...
    If Not objRs2.EOF Then
       ...
       'Obtengo el filtro utilizado como restricciones a la busqueda de embargos
        ...
        If tenro3 <> 0 Then ' esto ocurre solo cuando se seleccionan los tres niveles
                    StrSql = " SELECT DISTINCT embcuota.*, tipoemb.*, embargo.*,v_empleado.ternro,empleg, terape, terape2, ternom, ternom2 "
       ...
       Else
                ...
                cantRegistros = CInt(objRs.RecordCount)
                i = 1
