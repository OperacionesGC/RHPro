...
Dim tipos_hs_extras1 As String
Dim tipos_hs_extras2 As String
Dim tipos_hs_extras3 As String
Dim tipos_hs_extras4 As String
Dim tipos_hs_extras5 As String
...
'2)
   ...
   'Obtengo los parametros del proceso
       ...
       Do Until objRs2.EOF
          ...
          Select Case objRs2!confnrocol
             Case 2
                ...
                End If
             Case 3
                If objRs2!conftipo = "AC" Or objRs2!conftipo = "ACC" Then
                     Sueldo = Sueldo & "," & objRs2!confval
                    'Escala = objRs2!confval2
                Else
                    Sueldo = Sueldo & "," & objRs2!confval2
                End If
             ...
             Case 4
                ...
                'If objRs2!confval <> 0 Then
                   ' tipos_hs_aux = tipos_hs_aux & "," & objRs2!confval
                    
                    tipos_hs_extras1 = tipos_hs_extras1 & "," & objRs2!confval
                    lista_hs_extras = lista_hs_extras & "," & objRs2!confval
                    'lista_conceptos = lista_conceptos & "," & objRs2!confval4
                'End If
               
             Case 14
                  porc1 = objRs2!confval
                  lista_conceptos = lista_conceptos & "," & objRs2!confval2
             Case 5
                
               ' If objRs2!confval <> 0 Then
                   tipos_hs_extras2 = tipos_hs_extras2 & "," & objRs2!confval
                 '   tipos_hs_extras = tipos_hs_extras & "%" & objRs2!confval & "@," & objRs2!confval2 & ",@" & objRs2!confval3
                    lista_hs_extras = lista_hs_extras & "," & objRs2!confval
                    'lista_conceptos = lista_conceptos & "," & objRs2!confval4
              '  End If
             Case 15
                  porc2 = objRs2!confval
                  lista_conceptos = lista_conceptos & "," & objRs2!confval2
             Case 6
                
               ' If objRs2!confval <> 0 Then
                     tipos_hs_extras3 = tipos_hs_extras3 & "," & objRs2!confval
                    'tipos_hs_extras = tipos_hs_extras & "%" & objRs2!confval & "@," & objRs2!confval2 & ",@" & objRs2!confval3
                    lista_hs_extras = lista_hs_extras & "," & objRs2!confval
                   ' lista_conceptos = lista_conceptos & "," & objRs2!confval4
               ' End If
              Case 16
                  porc3 = objRs2!confval
                  lista_conceptos = lista_conceptos & "," & objRs2!confval2
             Case 7
                
                'If objRs2!confval <> 0 Then
                 tipos_hs_extras4 = tipos_hs_extras4 & "," & objRs2!confval
                   ' tipos_hs_extras = tipos_hs_extras & "%" & objRs2!confval & "@," & objRs2!confval2 & ",@" & objRs2!confval3
                    lista_hs_extras = lista_hs_extras & "," & objRs2!confval
               '   '  lista_conceptos = lista_conceptos & "," & objRs2!confval4
               ' End If
             Case 17
                  porc4 = objRs2!confval
                  lista_conceptos = lista_conceptos & "," & objRs2!confval2
             Case 8
                
                'If objRs2!confval <> 0 Then
                 tipos_hs_extras5 = tipos_hs_extras5 & "," & objRs2!confval
                   '  tipos_hs_extras = tipos_hs_extras & "%" & objRs2!confval & "@," & objRs2!confval2 & ",@" & objRs2!confval3
                     lista_hs_extras = lista_hs_extras & "," & objRs2!confval
                  '   lista_conceptos = lista_conceptos & "," & objRs2!confval4
                'End If
             Case 18
                  porc5 = objRs2!confval
                  lista_conceptos = lista_conceptos & "," & objRs2!confval2
             Case 9
                ...
                End If
              Case 10
                  Escala = objRs2!confval
                  
               Case 99
                If objRs2!confval2 <> "" Then
                    empresascongti = empresascongti & "," & objRs2!confval2
                End If
          End Select
       ...
       If tipos_hs_extras1 <> "0" Then
            tipos_hs_extras = tipos_hs_extras & "%-1@," & tipos_hs_extras1 & ",@" & porc1
       End If
       If tipos_hs_extras2 <> "0" Then
            tipos_hs_extras = tipos_hs_extras & "%-1@," & tipos_hs_extras2 & ",@" & porc2
       End If
       If tipos_hs_extras3 <> "0" Then
            tipos_hs_extras = tipos_hs_extras & "%-1@," & tipos_hs_extras3 & ",@" & porc3
       End If
       If tipos_hs_extras4 <> "0" Then
            tipos_hs_extras = tipos_hs_extras & "%-1@," & tipos_hs_extras4 & ",@" & porc4
       End If
       If tipos_hs_extras5 <> "0" Then
            tipos_hs_extras = tipos_hs_extras & "%-1@," & tipos_hs_extras5 & ",@" & porc5
          
       End If
       Flog.writeline "Tipos de horas extras" & tipos_hs_extras
...
End Sub
 ...
 Dim HEH_aux As String
  ...
  Dim horasalaux As String
    Flog.writeline " HoraEnt :" & HoraEnt
    Flog.writeline " HoraSal : " & HoraSal
    Flog.writeline " adcanthoras : " & adcanthoras
    TotDias = 0
    fechaSal = adfecha
    ...
    Flog.writeline " horas :" & horas
    Flog.writeline " minutos : " & minutos
 ...
 End If
 rsHorario.Close
    Flog.writeline " horas 2  :" & horas
    Flog.writeline " minutos 2 :" & minutos
End Sub
...
Else
    ...
    sql = sql & " INNER JOIN detliq   ON cabliq.cliqnro = detliq.cliqnro  AND cabliq.empleado = " & Ternro
    sql = sql & " INNER JOIN concepto ON detliq.concnro = concepto.concnro "
    sql = sql & " AND concepto.conccod IN (" & Sueldo & ")"
...
'------------------------------------------------------------------
         ...
         StrSql = " SELECT thnro, SUM(dlimonto) monto, SUM(dlicant) cantidad" & _
             ...
             " INNER JOIN concepto ON concepto.concnro = detliq.concnro AND concepto.concimp = -1   and concepto.conccod IN (" & lista_conceptos & ")" & _
                        ...
                        If rsAcumdiario!adcanthoras <= CHmes Then
                           ...
                           If horas + minutos > 0 Then
                             StrSql = " INSERT INTO repHorasSupDet " & _
                                 ...
                                 objConn.Execute StrSql, , adExecuteNoRecords
                              End If
                                  Flog.writeline " Insert1 sql:" & StrSql
                                 rsAcumdiario.MoveNext
                         Else
                               aux = ""
                               Flog.writeline " Insert2 "
                               If HoraEnt <> "" And HoraSal <> "" Then
                                ...
                                If horas + minutos > 0 Then
                                 ...
                                 "  ,repHsSupDet_monto,repHsSupDet_fcorta,repHsSupDet_error)" & _
                                     ...
                                     ",0)"
                                      objConn.Execute StrSql, , adExecuteNoRecords
                                      Flog.writeline " Insert3 sql:" & StrSql
                               End If
                              aux = ""
                                 ...
                                 If horas + minutos > 0 Then
                                    StrSql = " INSERT INTO repHorasSupDet " & _
                                        ...
                                        "  ,repHsSupDet_monto,repHsSupDet_fcorta,repHsSupDet_error)" & _
                                            ...
                                            objConn.Execute StrSql, , adExecuteNoRecords
                                            Flog.writeline " Insert4 sql:" & StrSql
                                     End If
                                     rsAcumdiario.MoveNext
                                     CHmes = 0
                        End If
                                     ...
                                     "'," & rsAcumdiario!adcanthoras & "," & posdec & ",0," & Porcentaje & "," & valorHoras & ",0," & ConvFecha(rsAcumdiario!adfecha) & ",1)" 'repHsSupDet_error = 1 Hay mas horas en Acudiario que en Detliq
                                      StrSql = " INSERT INTO repHorasSupDet " & _
                                        ...
                                        "  ,repHsSupDet_monto,repHsSupDet_fcorta,repHsSupDet_error)" & _
                                            ...
                                            ",1)"  'repHsSupDet_error = 1 Hay mas horas en AcuDiario que en detliq
                                     objConn.Execute StrSql, , adExecuteNoRecords
                                       Flog.writeline " Insert5 sql:" & StrSql
                                     rsAcumdiario.MoveNext
