Attribute VB_Name = "MdlValeCom"
Option Explicit

Const Version = 1.01
Const FechaVersion = "16/02/2007"
'Autor = Diego Rosso
'Reporte Vales Comida AGD
...
Dim ArrParametros
    ...
    StrSql = "SELECT * FROM batch_proceso WHERE btprcnro = 159 AND bpronro =" & NroProcesoBatch
...
Do While Not rs_Empleados.EOF
    ...
    StrSql = " INSERT INTO rep_vales_com "
    StrSql = StrSql & " ("
    ...
    End If
    StrSql = StrSql & " , " & Orden
    StrSql = StrSql & " , '" & rs_Empleados!valdesc & "'"
