...
'                                   Se cambió el nombre del archivo de log que se genera: Exp_LaEstrella_DJA-xxxx.log"
'                                   Se cambió el nombre del archivo que genera a Exp_Laestrella_DJA.txt"
...
Global Const UltimaModificacion = "Se cambió la extension del archivo que se genera de .csv a .txt" 'Carmen Quintero CAS-27083 - VISION BASE MARCO - BUG EN EXPORTACION DEL REPORTE DDJJ LA ESTRELLA
...
Dim ArrParametros
    ...
    'FGZ - 28/05/2012 - se cambió el nombre del archivo de log
...
If Not rs_Modelo.EOF Then
    ...
    Else
        Flog.writeline Espacios(Tabulador * 0) & "El modelo no tiene configurada la carpeta desteino. El archivo será generado en el directorio default"
    End If
Else
    Flog.writeline Espacios(Tabulador * 0) & "No se encontró el modelo. El archivo será generado en el directorio default"
End If
...
'FGZ - 28/05/2012 - se cambió el nombre del archivo que genera a Exp_Laestrella_DJA.txt"
'Archivo = Directorio & "\jub-mov.txt"
'07/10/2014 Se cambió la extension del archivo que se genera de .csv a .txt
...
If rs_Periodo.EOF Then
    Flog.writeline Espacios(Tabulador * 0) & "No se encontró el Periodo. Exportacion Abortada."
    Exit Sub
End If
...
If rs_Confrep.EOF Then
    Flog.writeline Espacios(Tabulador * 0) & "No se encontró la configuración del Reporte. Exportacion Abortada."
    Exit Sub
Else
...
Else
   ...
   OpenRecordset StrSql, rs_tipocod
    ...
    If rs_tipocod.EOF Then
        Flog.writeline Espacios(Tabulador * 2) & "No existe número de La Estrella para esta Empresa"
...
If Not rs_Modelo.EOF Then
   ...
   End If
Else
   Flog.writeline Espacios(Tabulador * 1) & "No se encontró el modelo 228. El archivo será generado en el directorio default"
End If
