...
'Global Const FechaModificacion = "31/12/2010"
'Global Const UltimaModificacion = "Version Inicial"
'Global Const UltimaModificacion1 = "" 'Diego Rosso

'Global Const Version = "1.01"
'Global Const FechaModificacion = "27/10/2015"
'Global Const UltimaModificacion = "Se aplica FormatNumber con 2 decimales a la variable monto."
'Global Const UltimaModificacion1 = "" 'Borrelli Facundo - CAS-33277 - Ingenio La Esperanza - Error en datos de reporte a Excel

Global Const Version = "1.02"
Global Const FechaModificacion = "10/11/2015"
Global Const UltimaModificacion = "Se aplica formato numerico al monto"
Global Const UltimaModificacion1 = "" 'Borrelli Facundo - CAS-33277 - Ingenio La Esperanza - Error en datos de reporte a Excel [Entrega 2]
...
strCmdLine = Command()
    ...
    StrSql = "SELECT * FROM batch_proceso WHERE btprcnro = 282 AND bpronro =" & NroProcesoBatch
...
'cargo el periodo
StrSql = "SELECT * FROM sim_rep_borradordeta "
...
Archivo = Directorio & "\SIM_Borrador_Det_" & rs_BorradorDeta!pliqdesc & "_Proceso_" & Proceso & ".csv"
Set fs = CreateObject("Scripting.FileSystemObject")
...
StrSql = "SELECT * FROM sim_rep_borrdeta_det "
StrSql = StrSql & " WHERE sim_rep_borrdeta_det.bpronro = " & Proceso
...
Do While Not rs_BorradorDeta.EOF
    ...
    StrSql = "SELECT * FROM sim_rep_borrdeta_det"
    StrSql = StrSql & " WHERE sim_rep_borrdeta_det.bpronro = " & Proceso
    StrSql = StrSql & " AND sim_rep_borrdeta_det.ternro = " & rs_BorradorDeta!Ternro
    StrSql = StrSql & " AND sim_rep_borrdeta_det.pronro = " & rs_BorradorDeta!pronro
    ...
    Do While Not rs_BorradorDeta_Det.EOF
        ...
        'FB - 10/11/2015 - Se agregó formateo a dos decimales para el monto.
        Aux_Linea = Aux_Linea & Separador & rs_BorradorDeta_Det!Conccod & Separador & rs_BorradorDeta_Det!concabr & Separador & rs_BorradorDeta_Det!dlicant & Separador & FormatNumber(rs_BorradorDeta_Det!dlimonto, 2)
        ' ------------------------------------------------------------------------
