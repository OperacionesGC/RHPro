...
Public Sub OpenConnection(strConnectionString As String, ByRef objConn As ADODB.Connection)
    ...
    objConn.CommandTimeout = 3600 '20120802 Lisandor Moro 60 * 3600
...
Public Function identity_on(Tabla As String)
    ' ---------------------------------------------------------------------------------------------
    ' Descripcion: Desactiva los campos identidades de una tabla
    ' Autor      : Lisandro Moro
    ' Fecha      : 13/09/2011
    ' Ultima Mod.:
    ' Descripcion:
    ...
    Select Case TipoBD
        ...
        Case 2 'Informix
            aux = " "
        Case 3 'SQL Server
            aux = " SET IDENTITY_INSERT " & Tabla & " ON "
        Case 4 'Oracle
            aux = "  "
        Case Else 'Default en SQL
            aux = "  "
...
Public Function identity_off(Tabla As String)
    ' ---------------------------------------------------------------------------------------------
    ' Descripcion: Activa los campos identidades de una tabla
    ' Autor      : Lisandro Moro
    ' Fecha      : 13/09/2011
    ' Ultima Mod.:
    ' Descripcion:
    ...
    Select Case TipoBD
        ...
        Case 2 'Informix
            aux = " "
        Case 3 'SQL Server
            aux = " SET IDENTITY_INSERT " & Tabla & " OFF "
        Case 4 'Oracle
            aux = "  "
        Case Else 'Default en SQL
            aux = "  "
